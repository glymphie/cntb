...
func (o IpV43) MarshalJSON() ([]byte, error) {
...
type NullableIpV43 struct {
	value *IpV43
	isSet bool
}

func (v NullableIpV43) Get() *IpV43 {
	return v.value
}

func (v *NullableIpV43) Set(val *IpV43) {
	v.value = val
	v.isSet = true
}

func (v NullableIpV43) IsSet() bool {
	return v.isSet
}

func (v *NullableIpV43) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpV43(val *IpV43) *NullableIpV43 {
	return &NullableIpV43{value: val, isSet: true}
}

func (v NullableIpV43) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpV43) UnmarshalJSON(src []byte) error {
	v.isSet = true
