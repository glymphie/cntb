...
func (o ListRoleResponse) MarshalJSON() ([]byte, error) {
...
type NullableListRoleResponse struct {
	value *ListRoleResponse
	isSet bool
}

func (v NullableListRoleResponse) Get() *ListRoleResponse {
	return v.value
}

func (v *NullableListRoleResponse) Set(val *ListRoleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListRoleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListRoleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRoleResponse(val *ListRoleResponse) *NullableListRoleResponse {
	return &NullableListRoleResponse{value: val, isSet: true}
}

func (v NullableListRoleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRoleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
