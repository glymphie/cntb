...
// UserAuditResponse struct for UserAuditResponse
...
func (o UserAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableUserAuditResponse struct {
	value *UserAuditResponse
	isSet bool
}

func (v NullableUserAuditResponse) Get() *UserAuditResponse {
	return v.value
}

func (v *NullableUserAuditResponse) Set(val *UserAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserAuditResponse(val *UserAuditResponse) *NullableUserAuditResponse {
	return &NullableUserAuditResponse{value: val, isSet: true}
}

func (v NullableUserAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
