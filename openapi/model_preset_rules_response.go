...
// PresetRulesResponse struct for PresetRulesResponse
type PresetRulesResponse struct {
	// Name of the preset rule
...
func (o PresetRulesResponse) MarshalJSON() ([]byte, error) {
...
type NullablePresetRulesResponse struct {
	value *PresetRulesResponse
	isSet bool
}

func (v NullablePresetRulesResponse) Get() *PresetRulesResponse {
	return v.value
}

func (v *NullablePresetRulesResponse) Set(val *PresetRulesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePresetRulesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePresetRulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresetRulesResponse(val *PresetRulesResponse) *NullablePresetRulesResponse {
	return &NullablePresetRulesResponse{value: val, isSet: true}
}

func (v NullablePresetRulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresetRulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
