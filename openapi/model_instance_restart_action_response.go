...
// InstanceRestartActionResponse struct for InstanceRestartActionResponse
...
func NewInstanceRestartActionResponse(data []InstanceRestartActionResponseData, links SelfLinks) *InstanceRestartActionResponse {
	this := InstanceRestartActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceRestartActionResponse) GetData() []InstanceRestartActionResponseData {
	if o == nil {
		var ret []InstanceRestartActionResponseData
		return ret
	}
...
func (o InstanceRestartActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceRestartActionResponse struct {
	value *InstanceRestartActionResponse
	isSet bool
}

func (v NullableInstanceRestartActionResponse) Get() *InstanceRestartActionResponse {
	return v.value
}

func (v *NullableInstanceRestartActionResponse) Set(val *InstanceRestartActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceRestartActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceRestartActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceRestartActionResponse(val *InstanceRestartActionResponse) *NullableInstanceRestartActionResponse {
	return &NullableInstanceRestartActionResponse{value: val, isSet: true}
}

func (v NullableInstanceRestartActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceRestartActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
