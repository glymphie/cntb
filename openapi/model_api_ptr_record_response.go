...
// ApiPtrRecordResponse struct for ApiPtrRecordResponse
type ApiPtrRecordResponse struct {
...
func (o ApiPtrRecordResponse) MarshalJSON() ([]byte, error) {
...
type NullableApiPtrRecordResponse struct {
	value *ApiPtrRecordResponse
	isSet bool
}

func (v NullableApiPtrRecordResponse) Get() *ApiPtrRecordResponse {
	return v.value
}

func (v *NullableApiPtrRecordResponse) Set(val *ApiPtrRecordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPtrRecordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPtrRecordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPtrRecordResponse(val *ApiPtrRecordResponse) *NullableApiPtrRecordResponse {
	return &NullableApiPtrRecordResponse{value: val, isSet: true}
}

func (v NullableApiPtrRecordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPtrRecordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
