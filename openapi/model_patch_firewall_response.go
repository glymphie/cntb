...
// PatchFirewallResponse struct for PatchFirewallResponse
...
func (o PatchFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullablePatchFirewallResponse struct {
	value *PatchFirewallResponse
	isSet bool
}

func (v NullablePatchFirewallResponse) Get() *PatchFirewallResponse {
	return v.value
}

func (v *NullablePatchFirewallResponse) Set(val *PatchFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchFirewallResponse(val *PatchFirewallResponse) *NullablePatchFirewallResponse {
	return &NullablePatchFirewallResponse{value: val, isSet: true}
}

func (v NullablePatchFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
