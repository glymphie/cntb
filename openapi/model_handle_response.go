...
// HandleResponse struct for HandleResponse
type HandleResponse struct {
	...
	// Flag if the handle is default or not
...
func (o HandleResponse) MarshalJSON() ([]byte, error) {
...
type NullableHandleResponse struct {
	value *HandleResponse
	isSet bool
}

func (v NullableHandleResponse) Get() *HandleResponse {
	return v.value
}

func (v *NullableHandleResponse) Set(val *HandleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHandleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHandleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandleResponse(val *HandleResponse) *NullableHandleResponse {
	return &NullableHandleResponse{value: val, isSet: true}
}

func (v NullableHandleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
