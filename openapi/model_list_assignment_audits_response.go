...
// ListAssignmentAuditsResponse struct for ListAssignmentAuditsResponse
...
func NewListAssignmentAuditsResponse(pagination PaginationMeta, data []AssignmentAuditResponse, links Links) *ListAssignmentAuditsResponse {
	this := ListAssignmentAuditsResponse{}
...
func (o *ListAssignmentAuditsResponse) GetData() []AssignmentAuditResponse {
	if o == nil {
		var ret []AssignmentAuditResponse
		return ret
	}
...
func (o ListAssignmentAuditsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAssignmentAuditsResponse struct {
	value *ListAssignmentAuditsResponse
	isSet bool
}

func (v NullableListAssignmentAuditsResponse) Get() *ListAssignmentAuditsResponse {
	return v.value
}

func (v *NullableListAssignmentAuditsResponse) Set(val *ListAssignmentAuditsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssignmentAuditsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssignmentAuditsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssignmentAuditsResponse(val *ListAssignmentAuditsResponse) *NullableListAssignmentAuditsResponse {
	return &NullableListAssignmentAuditsResponse{value: val, isSet: true}
}

func (v NullableListAssignmentAuditsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssignmentAuditsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
