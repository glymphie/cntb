...
// ListObjectStorageResponse struct for ListObjectStorageResponse
...
func NewListObjectStorageResponse(pagination PaginationMeta, data []ObjectStorageResponse, links Links) *ListObjectStorageResponse {
	this := ListObjectStorageResponse{}
...
func (o ListObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableListObjectStorageResponse struct {
	value *ListObjectStorageResponse
	isSet bool
}

func (v NullableListObjectStorageResponse) Get() *ListObjectStorageResponse {
	return v.value
}

func (v *NullableListObjectStorageResponse) Set(val *ListObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListObjectStorageResponse(val *ListObjectStorageResponse) *NullableListObjectStorageResponse {
	return &NullableListObjectStorageResponse{value: val, isSet: true}
}

func (v NullableListObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
