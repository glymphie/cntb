...
// HandleAuditResponse struct for HandleAuditResponse
type HandleAuditResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []HandleAuditResponseData `json:"data"`
...
func (o *HandleAuditResponse) GetData() []HandleAuditResponseData {
	if o == nil {
		var ret []HandleAuditResponseData
		return ret
	}
...
func (o HandleAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableHandleAuditResponse struct {
	value *HandleAuditResponse
	isSet bool
}

func (v NullableHandleAuditResponse) Get() *HandleAuditResponse {
	return v.value
}

func (v *NullableHandleAuditResponse) Set(val *HandleAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHandleAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHandleAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandleAuditResponse(val *HandleAuditResponse) *NullableHandleAuditResponse {
	return &NullableHandleAuditResponse{value: val, isSet: true}
}

func (v NullableHandleAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandleAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
