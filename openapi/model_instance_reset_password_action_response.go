...
// InstanceResetPasswordActionResponse struct for InstanceResetPasswordActionResponse
...
func NewInstanceResetPasswordActionResponse(data []InstanceResetPasswordActionResponseData, links SelfLinks) *InstanceResetPasswordActionResponse {
	this := InstanceResetPasswordActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceResetPasswordActionResponse) GetData() []InstanceResetPasswordActionResponseData {
	if o == nil {
		var ret []InstanceResetPasswordActionResponseData
		return ret
	}
...
func (o InstanceResetPasswordActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceResetPasswordActionResponse struct {
	value *InstanceResetPasswordActionResponse
	isSet bool
}

func (v NullableInstanceResetPasswordActionResponse) Get() *InstanceResetPasswordActionResponse {
	return v.value
}

func (v *NullableInstanceResetPasswordActionResponse) Set(val *InstanceResetPasswordActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceResetPasswordActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceResetPasswordActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceResetPasswordActionResponse(val *InstanceResetPasswordActionResponse) *NullableInstanceResetPasswordActionResponse {
	return &NullableInstanceResetPasswordActionResponse{value: val, isSet: true}
}

func (v NullableInstanceResetPasswordActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceResetPasswordActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
