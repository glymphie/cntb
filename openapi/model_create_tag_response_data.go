...
// CreateTagResponseData struct for CreateTagResponseData
...
func (o CreateTagResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateTagResponseData struct {
	value *CreateTagResponseData
	isSet bool
}

func (v NullableCreateTagResponseData) Get() *CreateTagResponseData {
	return v.value
}

func (v *NullableCreateTagResponseData) Set(val *CreateTagResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTagResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTagResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTagResponseData(val *CreateTagResponseData) *NullableCreateTagResponseData {
	return &NullableCreateTagResponseData{value: val, isSet: true}
}

func (v NullableCreateTagResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTagResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
