...
// ListInstancesAuditResponse struct for ListInstancesAuditResponse
...
func NewListInstancesAuditResponse(pagination PaginationMeta, data []InstancesAuditResponse, links Links) *ListInstancesAuditResponse {
	this := ListInstancesAuditResponse{}
...
func (o *ListInstancesAuditResponse) GetData() []InstancesAuditResponse {
	if o == nil {
		var ret []InstancesAuditResponse
		return ret
	}
...
func (o ListInstancesAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListInstancesAuditResponse struct {
	value *ListInstancesAuditResponse
	isSet bool
}

func (v NullableListInstancesAuditResponse) Get() *ListInstancesAuditResponse {
	return v.value
}

func (v *NullableListInstancesAuditResponse) Set(val *ListInstancesAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListInstancesAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListInstancesAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInstancesAuditResponse(val *ListInstancesAuditResponse) *NullableListInstancesAuditResponse {
	return &NullableListInstancesAuditResponse{value: val, isSet: true}
}

func (v NullableListInstancesAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInstancesAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
