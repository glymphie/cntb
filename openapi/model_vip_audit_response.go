...
// VipAuditResponse struct for VipAuditResponse
...
func (o VipAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableVipAuditResponse struct {
	value *VipAuditResponse
	isSet bool
}

func (v NullableVipAuditResponse) Get() *VipAuditResponse {
	return v.value
}

func (v *NullableVipAuditResponse) Set(val *VipAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVipAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVipAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVipAuditResponse(val *VipAuditResponse) *NullableVipAuditResponse {
	return &NullableVipAuditResponse{value: val, isSet: true}
}

func (v NullableVipAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVipAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
