...
// CancelObjectStorageResponse struct for CancelObjectStorageResponse
...
func NewCancelObjectStorageResponse(links SelfLinks, data []CancelObjectStorageResponseData) *CancelObjectStorageResponse {
	this := CancelObjectStorageResponse{}
	this.Links = links
	this.Data = data
	return &this
}
...
func (o *CancelObjectStorageResponse) GetData() []CancelObjectStorageResponseData {
	if o == nil {
		var ret []CancelObjectStorageResponseData
		return ret
	}
...
func (o CancelObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableCancelObjectStorageResponse struct {
	value *CancelObjectStorageResponse
	isSet bool
}

func (v NullableCancelObjectStorageResponse) Get() *CancelObjectStorageResponse {
	return v.value
}

func (v *NullableCancelObjectStorageResponse) Set(val *CancelObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelObjectStorageResponse(val *CancelObjectStorageResponse) *NullableCancelObjectStorageResponse {
	return &NullableCancelObjectStorageResponse{value: val, isSet: true}
}

func (v NullableCancelObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
