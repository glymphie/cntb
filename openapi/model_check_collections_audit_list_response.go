...
// CheckCollectionsAuditListResponse struct for CheckCollectionsAuditListResponse
type CheckCollectionsAuditListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []CheckCollectionsAuditResponse `json:"data"`
...
func NewCheckCollectionsAuditListResponse(pagination PaginationMeta, data []CheckCollectionsAuditResponse, links Links) *CheckCollectionsAuditListResponse {
	this := CheckCollectionsAuditListResponse{}
...
func (o *CheckCollectionsAuditListResponse) GetData() []CheckCollectionsAuditResponse {
	if o == nil {
		var ret []CheckCollectionsAuditResponse
		return ret
	}
...
func (o CheckCollectionsAuditListResponse) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionsAuditListResponse struct {
	value *CheckCollectionsAuditListResponse
	isSet bool
}

func (v NullableCheckCollectionsAuditListResponse) Get() *CheckCollectionsAuditListResponse {
	return v.value
}

func (v *NullableCheckCollectionsAuditListResponse) Set(val *CheckCollectionsAuditListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionsAuditListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionsAuditListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionsAuditListResponse(val *CheckCollectionsAuditListResponse) *NullableCheckCollectionsAuditListResponse {
	return &NullableCheckCollectionsAuditListResponse{value: val, isSet: true}
}

func (v NullableCheckCollectionsAuditListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionsAuditListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
