...
/*
CreateCustomImage Provide a custom image
...
/*
DeleteImage Delete an uploaded custom image by its id
...
/*
RetrieveCustomImagesStats List statistics regarding the customer's custom images
...
/*
RetrieveImage Get details about a specific image by its id
...
func (r ApiRetrieveImageListRequest) Search(search string) ApiRetrieveImageListRequest {
	r.search = &search
	return r
}
...
/*
RetrieveImageList List available standard and custom images
...
/*
UpdateImage Update custom image name by its id
