...
// PatchVncRequest struct for PatchVncRequest
type PatchVncRequest struct {
...
func (o PatchVncRequest) MarshalJSON() ([]byte, error) {
...
type NullablePatchVncRequest struct {
	value *PatchVncRequest
	isSet bool
}

func (v NullablePatchVncRequest) Get() *PatchVncRequest {
	return v.value
}

func (v *NullablePatchVncRequest) Set(val *PatchVncRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchVncRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchVncRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchVncRequest(val *PatchVncRequest) *NullablePatchVncRequest {
	return &NullablePatchVncRequest{value: val, isSet: true}
}

func (v NullablePatchVncRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchVncRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
