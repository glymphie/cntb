...
// ListFirewallResponseData struct for ListFirewallResponseData
type ListFirewallResponseData struct {
	...
	// Inactive status means no rules of this firewall are set for all assigned instances.
	Status string `json:"status"`
	InstanceStatus []InstanceStatusRepresentation `json:"instanceStatus"`
	Instances []InstanceDetails `json:"instances"`
	Rules Rules `json:"rules"`
	// The creation date time for the firewall
	CreatedDate time.Time `json:"createdDate"`
	// The update date time for the firewall
...
func NewListFirewallResponseData(tenantId string, customerId string, firewallId string, name string, description string, status string, instanceStatus []InstanceStatusRepresentation, instances []InstanceDetails, rules Rules, createdDate time.Time, updatedDate time.Time) *ListFirewallResponseData {
	this := ListFirewallResponseData{}
...
// GetInstanceStatus returns the InstanceStatus field value
func (o *ListFirewallResponseData) GetInstanceStatus() []InstanceStatusRepresentation {
	if o == nil {
		var ret []InstanceStatusRepresentation
		return ret
	}
...
// GetInstanceStatusOk returns a tuple with the InstanceStatus field value
// and a boolean to check if the value has been set.
func (o *ListFirewallResponseData) GetInstanceStatusOk() (*[]InstanceStatusRepresentation, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.InstanceStatus, true
}

// SetInstanceStatus sets field value
...
func (o ListFirewallResponseData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["firewallId"] = o.FirewallId
	}
	if true {
	...
	if true {
		toSerialize["instanceStatus"] = o.InstanceStatus
	}
	if true {
...
type NullableListFirewallResponseData struct {
	value *ListFirewallResponseData
	isSet bool
}

func (v NullableListFirewallResponseData) Get() *ListFirewallResponseData {
	return v.value
}

func (v *NullableListFirewallResponseData) Set(val *ListFirewallResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListFirewallResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListFirewallResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFirewallResponseData(val *ListFirewallResponseData) *NullableListFirewallResponseData {
	return &NullableListFirewallResponseData{value: val, isSet: true}
}

func (v NullableListFirewallResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFirewallResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
