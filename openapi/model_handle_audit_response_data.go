...
// HandleAuditResponseData struct for HandleAuditResponseData
type HandleAuditResponseData struct {
...
// GetHandleId returns the HandleId field value
...
// GetHandleIdOk returns a tuple with the HandleId field value
// and a boolean to check if the value has been set.
...
func (o HandleAuditResponseData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["handleId"] = o.HandleId
	}
	if o.Changes != nil {
...
type NullableHandleAuditResponseData struct {
	value *HandleAuditResponseData
	isSet bool
}

func (v NullableHandleAuditResponseData) Get() *HandleAuditResponseData {
	return v.value
}

func (v *NullableHandleAuditResponseData) Set(val *HandleAuditResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableHandleAuditResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableHandleAuditResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandleAuditResponseData(val *HandleAuditResponseData) *NullableHandleAuditResponseData {
	return &NullableHandleAuditResponseData{value: val, isSet: true}
}

func (v NullableHandleAuditResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandleAuditResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
