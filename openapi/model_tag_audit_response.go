...
// TagAuditResponse struct for TagAuditResponse
...
func (o TagAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableTagAuditResponse struct {
	value *TagAuditResponse
	isSet bool
}

func (v NullableTagAuditResponse) Get() *TagAuditResponse {
	return v.value
}

func (v *NullableTagAuditResponse) Set(val *TagAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTagAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTagAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagAuditResponse(val *TagAuditResponse) *NullableTagAuditResponse {
	return &NullableTagAuditResponse{value: val, isSet: true}
}

func (v NullableTagAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
