...
// CustomImagesStatsResponse struct for CustomImagesStatsResponse
...
func NewCustomImagesStatsResponse(data []CustomImagesStatsResponseData, links SelfLinks) *CustomImagesStatsResponse {
	this := CustomImagesStatsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CustomImagesStatsResponse) GetData() []CustomImagesStatsResponseData {
	if o == nil {
		var ret []CustomImagesStatsResponseData
		return ret
	}
...
func (o CustomImagesStatsResponse) MarshalJSON() ([]byte, error) {
...
type NullableCustomImagesStatsResponse struct {
	value *CustomImagesStatsResponse
	isSet bool
}

func (v NullableCustomImagesStatsResponse) Get() *CustomImagesStatsResponse {
	return v.value
}

func (v *NullableCustomImagesStatsResponse) Set(val *CustomImagesStatsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomImagesStatsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomImagesStatsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomImagesStatsResponse(val *CustomImagesStatsResponse) *NullableCustomImagesStatsResponse {
	return &NullableCustomImagesStatsResponse{value: val, isSet: true}
}

func (v NullableCustomImagesStatsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomImagesStatsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
