...
// CreatePrivateNetworkResponse struct for CreatePrivateNetworkResponse
...
func NewCreatePrivateNetworkResponse(data []PrivateNetworkResponse, links SelfLinks) *CreatePrivateNetworkResponse {
	this := CreatePrivateNetworkResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CreatePrivateNetworkResponse) GetData() []PrivateNetworkResponse {
	if o == nil {
		var ret []PrivateNetworkResponse
		return ret
	}
...
func (o CreatePrivateNetworkResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreatePrivateNetworkResponse struct {
	value *CreatePrivateNetworkResponse
	isSet bool
}

func (v NullableCreatePrivateNetworkResponse) Get() *CreatePrivateNetworkResponse {
	return v.value
}

func (v *NullableCreatePrivateNetworkResponse) Set(val *CreatePrivateNetworkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePrivateNetworkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePrivateNetworkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePrivateNetworkResponse(val *CreatePrivateNetworkResponse) *NullableCreatePrivateNetworkResponse {
	return &NullableCreatePrivateNetworkResponse{value: val, isSet: true}
}

func (v NullableCreatePrivateNetworkResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePrivateNetworkResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
