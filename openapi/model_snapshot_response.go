...
// GetAutoDeleteDate returns the AutoDeleteDate field value
func (o *SnapshotResponse) GetAutoDeleteDate() time.Time {
	...
	return o.AutoDeleteDate
}

// GetAutoDeleteDateOk returns a tuple with the AutoDeleteDate field value
// and a boolean to check if the value has been set.
func (o *SnapshotResponse) GetAutoDeleteDateOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AutoDeleteDate, true
}

// SetAutoDeleteDate sets field value
...
func (o SnapshotResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["autoDeleteDate"] = o.AutoDeleteDate
	}
	if true {
