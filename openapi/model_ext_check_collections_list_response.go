...
// ExtCheckCollectionsListResponse struct for ExtCheckCollectionsListResponse
type ExtCheckCollectionsListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []ExtCheckCollectionResponse `json:"data"`
...
func NewExtCheckCollectionsListResponse(pagination PaginationMeta, data []ExtCheckCollectionResponse, links Links) *ExtCheckCollectionsListResponse {
	this := ExtCheckCollectionsListResponse{}
...
func (o *ExtCheckCollectionsListResponse) GetData() []ExtCheckCollectionResponse {
	if o == nil {
		var ret []ExtCheckCollectionResponse
		return ret
	}
...
func (o ExtCheckCollectionsListResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtCheckCollectionsListResponse struct {
	value *ExtCheckCollectionsListResponse
	isSet bool
}

func (v NullableExtCheckCollectionsListResponse) Get() *ExtCheckCollectionsListResponse {
	return v.value
}

func (v *NullableExtCheckCollectionsListResponse) Set(val *ExtCheckCollectionsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtCheckCollectionsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtCheckCollectionsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtCheckCollectionsListResponse(val *ExtCheckCollectionsListResponse) *NullableExtCheckCollectionsListResponse {
	return &NullableExtCheckCollectionsListResponse{value: val, isSet: true}
}

func (v NullableExtCheckCollectionsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtCheckCollectionsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
