...
// FindVncResponse struct for FindVncResponse
type FindVncResponse struct {
	Data []VncResponse `json:"data"`
...
func (o FindVncResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindVncResponse struct {
	value *FindVncResponse
	isSet bool
}

func (v NullableFindVncResponse) Get() *FindVncResponse {
	return v.value
}

func (v *NullableFindVncResponse) Set(val *FindVncResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindVncResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindVncResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindVncResponse(val *FindVncResponse) *NullableFindVncResponse {
	return &NullableFindVncResponse{value: val, isSet: true}
}

func (v NullableFindVncResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindVncResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
