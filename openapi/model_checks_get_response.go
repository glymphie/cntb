...
// ChecksGetResponse struct for ChecksGetResponse
...
func (o ChecksGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableChecksGetResponse struct {
	value *ChecksGetResponse
	isSet bool
}

func (v NullableChecksGetResponse) Get() *ChecksGetResponse {
	return v.value
}

func (v *NullableChecksGetResponse) Set(val *ChecksGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksGetResponse(val *ChecksGetResponse) *NullableChecksGetResponse {
	return &NullableChecksGetResponse{value: val, isSet: true}
}

func (v NullableChecksGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChecksGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
