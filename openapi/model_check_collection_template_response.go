...
// CheckCollectionTemplateResponse struct for CheckCollectionTemplateResponse
type CheckCollectionTemplateResponse struct {
	// Creation date
	...
	// Check collection template's id
	CheckCollectionTemplateId float32 `json:"checkCollectionTemplateId"`
	// Name of the check collection template
	Name string `json:"name"`
	// Description for the check collection template
	Description string `json:"description"`
	// Is check collection only internal (not shown to the customer)
	Internal bool `json:"internal"`
	// Object type for which the check collection template can be used
	ObjectType string `json:"objectType"`
	// Check templates which are part of this collection template
	CheckTemplates []CheckCollectionTemplatesCheckTemplates `json:"checkTemplates"`
}
...
func NewCheckCollectionTemplateResponse(createdDate time.Time, modifiedDate time.Time, orgId string, accountId string, checkCollectionTemplateId float32, name string, description string, internal bool, objectType string, checkTemplates []CheckCollectionTemplatesCheckTemplates) *CheckCollectionTemplateResponse {
	this := CheckCollectionTemplateResponse{}
...
func (o CheckCollectionTemplateResponse) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionTemplateResponse struct {
	value *CheckCollectionTemplateResponse
	isSet bool
}

func (v NullableCheckCollectionTemplateResponse) Get() *CheckCollectionTemplateResponse {
	return v.value
}

func (v *NullableCheckCollectionTemplateResponse) Set(val *CheckCollectionTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionTemplateResponse(val *CheckCollectionTemplateResponse) *NullableCheckCollectionTemplateResponse {
	return &NullableCheckCollectionTemplateResponse{value: val, isSet: true}
}

func (v NullableCheckCollectionTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
