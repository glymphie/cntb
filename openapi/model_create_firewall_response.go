...
// CreateFirewallResponse struct for CreateFirewallResponse
type CreateFirewallResponse struct {
	Data []FirewallResponse `json:"data"`
...
func (o CreateFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateFirewallResponse struct {
	value *CreateFirewallResponse
	isSet bool
}

func (v NullableCreateFirewallResponse) Get() *CreateFirewallResponse {
	return v.value
}

func (v *NullableCreateFirewallResponse) Set(val *CreateFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFirewallResponse(val *CreateFirewallResponse) *NullableCreateFirewallResponse {
	return &NullableCreateFirewallResponse{value: val, isSet: true}
}

func (v NullableCreateFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
