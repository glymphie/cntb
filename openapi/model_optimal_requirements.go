...
// OptimalRequirements struct for OptimalRequirements
type OptimalRequirements struct {
...
func (o OptimalRequirements) MarshalJSON() ([]byte, error) {
...
type NullableOptimalRequirements struct {
	value *OptimalRequirements
	isSet bool
}

func (v NullableOptimalRequirements) Get() *OptimalRequirements {
	return v.value
}

func (v *NullableOptimalRequirements) Set(val *OptimalRequirements) {
	v.value = val
	v.isSet = true
}

func (v NullableOptimalRequirements) IsSet() bool {
	return v.isSet
}

func (v *NullableOptimalRequirements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptimalRequirements(val *OptimalRequirements) *NullableOptimalRequirements {
	return &NullableOptimalRequirements{value: val, isSet: true}
}

func (v NullableOptimalRequirements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptimalRequirements) UnmarshalJSON(src []byte) error {
	v.isSet = true
