...
// CheckCollectionCreateRequest struct for CheckCollectionCreateRequest
type CheckCollectionCreateRequest struct {
...
func NewCheckCollectionCreateRequest(objectType string, objectId string, checkCollectionTemplateId float32, orgId string, accountId string) *CheckCollectionCreateRequest {
	this := CheckCollectionCreateRequest{}
...
func (o CheckCollectionCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionCreateRequest struct {
	value *CheckCollectionCreateRequest
	isSet bool
}

func (v NullableCheckCollectionCreateRequest) Get() *CheckCollectionCreateRequest {
	return v.value
}

func (v *NullableCheckCollectionCreateRequest) Set(val *CheckCollectionCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionCreateRequest(val *CheckCollectionCreateRequest) *NullableCheckCollectionCreateRequest {
	return &NullableCheckCollectionCreateRequest{value: val, isSet: true}
}

func (v NullableCheckCollectionCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
