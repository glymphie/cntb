...
// BaseCheckCollectionCreateRequest struct for BaseCheckCollectionCreateRequest
type BaseCheckCollectionCreateRequest struct {
	// Object type to be handled
	ObjectType string `json:"objectType"`
	// ID of the object, to be handled
	ObjectId string `json:"objectId"`
	// Check Template for this check collection
...
func NewBaseCheckCollectionCreateRequest(objectType string, objectId string, checkCollectionTemplateId float32) *BaseCheckCollectionCreateRequest {
	this := BaseCheckCollectionCreateRequest{}
...
func (o BaseCheckCollectionCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableBaseCheckCollectionCreateRequest struct {
	value *BaseCheckCollectionCreateRequest
	isSet bool
}

func (v NullableBaseCheckCollectionCreateRequest) Get() *BaseCheckCollectionCreateRequest {
	return v.value
}

func (v *NullableBaseCheckCollectionCreateRequest) Set(val *BaseCheckCollectionCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseCheckCollectionCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseCheckCollectionCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseCheckCollectionCreateRequest(val *BaseCheckCollectionCreateRequest) *NullableBaseCheckCollectionCreateRequest {
	return &NullableBaseCheckCollectionCreateRequest{value: val, isSet: true}
}

func (v NullableBaseCheckCollectionCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseCheckCollectionCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
