...
// ExtRemediesGetResponse struct for ExtRemediesGetResponse
type ExtRemediesGetResponse struct {
...
func (o ExtRemediesGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtRemediesGetResponse struct {
	value *ExtRemediesGetResponse
	isSet bool
}

func (v NullableExtRemediesGetResponse) Get() *ExtRemediesGetResponse {
	return v.value
}

func (v *NullableExtRemediesGetResponse) Set(val *ExtRemediesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtRemediesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtRemediesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtRemediesGetResponse(val *ExtRemediesGetResponse) *NullableExtRemediesGetResponse {
	return &NullableExtRemediesGetResponse{value: val, isSet: true}
}

func (v NullableExtRemediesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtRemediesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
