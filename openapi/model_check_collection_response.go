...
// CheckCollectionResponse struct for CheckCollectionResponse
...
func (o CheckCollectionResponse) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionResponse struct {
	value *CheckCollectionResponse
	isSet bool
}

func (v NullableCheckCollectionResponse) Get() *CheckCollectionResponse {
	return v.value
}

func (v *NullableCheckCollectionResponse) Set(val *CheckCollectionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionResponse(val *CheckCollectionResponse) *NullableCheckCollectionResponse {
	return &NullableCheckCollectionResponse{value: val, isSet: true}
}

func (v NullableCheckCollectionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
