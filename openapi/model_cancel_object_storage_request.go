...
// CancelObjectStorageRequest struct for CancelObjectStorageRequest
...
func NewCancelObjectStorageRequest() *CancelObjectStorageRequest {
	this := CancelObjectStorageRequest{}
	return &this
}
...
func (o CancelObjectStorageRequest) MarshalJSON() ([]byte, error) {
...
type NullableCancelObjectStorageRequest struct {
	value *CancelObjectStorageRequest
	isSet bool
}

func (v NullableCancelObjectStorageRequest) Get() *CancelObjectStorageRequest {
	return v.value
}

func (v *NullableCancelObjectStorageRequest) Set(val *CancelObjectStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelObjectStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelObjectStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelObjectStorageRequest(val *CancelObjectStorageRequest) *NullableCancelObjectStorageRequest {
	return &NullableCancelObjectStorageRequest{value: val, isSet: true}
}

func (v NullableCancelObjectStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelObjectStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
