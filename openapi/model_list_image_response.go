...
// ListImageResponse struct for ListImageResponse
...
func (o ListImageResponse) MarshalJSON() ([]byte, error) {
...
type NullableListImageResponse struct {
	value *ListImageResponse
	isSet bool
}

func (v NullableListImageResponse) Get() *ListImageResponse {
	return v.value
}

func (v *NullableListImageResponse) Set(val *ListImageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListImageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListImageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListImageResponse(val *ListImageResponse) *NullableListImageResponse {
	return &NullableListImageResponse{value: val, isSet: true}
}

func (v NullableListImageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListImageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
