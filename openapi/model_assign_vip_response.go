...
// AssignVipResponse struct for AssignVipResponse
...
func (o AssignVipResponse) MarshalJSON() ([]byte, error) {
...
type NullableAssignVipResponse struct {
	value *AssignVipResponse
	isSet bool
}

func (v NullableAssignVipResponse) Get() *AssignVipResponse {
	return v.value
}

func (v *NullableAssignVipResponse) Set(val *AssignVipResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignVipResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignVipResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignVipResponse(val *AssignVipResponse) *NullableAssignVipResponse {
	return &NullableAssignVipResponse{value: val, isSet: true}
}

func (v NullableAssignVipResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignVipResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
