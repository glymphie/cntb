...
// RemedyTemplatesGetResponse struct for RemedyTemplatesGetResponse
type RemedyTemplatesGetResponse struct {
...
func NewRemedyTemplatesGetResponse(data []RemedyTemplateResponse, links SelfLinks) *RemedyTemplatesGetResponse {
	this := RemedyTemplatesGetResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o RemedyTemplatesGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableRemedyTemplatesGetResponse struct {
	value *RemedyTemplatesGetResponse
	isSet bool
}

func (v NullableRemedyTemplatesGetResponse) Get() *RemedyTemplatesGetResponse {
	return v.value
}

func (v *NullableRemedyTemplatesGetResponse) Set(val *RemedyTemplatesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemedyTemplatesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemedyTemplatesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemedyTemplatesGetResponse(val *RemedyTemplatesGetResponse) *NullableRemedyTemplatesGetResponse {
	return &NullableRemedyTemplatesGetResponse{value: val, isSet: true}
}

func (v NullableRemedyTemplatesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemedyTemplatesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
