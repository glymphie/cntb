...
// ZoneAuditResponseData struct for ZoneAuditResponseData
type ZoneAuditResponseData struct {
...
func (o ZoneAuditResponseData) MarshalJSON() ([]byte, error) {
...
type NullableZoneAuditResponseData struct {
	value *ZoneAuditResponseData
	isSet bool
}

func (v NullableZoneAuditResponseData) Get() *ZoneAuditResponseData {
	return v.value
}

func (v *NullableZoneAuditResponseData) Set(val *ZoneAuditResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneAuditResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneAuditResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneAuditResponseData(val *ZoneAuditResponseData) *NullableZoneAuditResponseData {
	return &NullableZoneAuditResponseData{value: val, isSet: true}
}

func (v NullableZoneAuditResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneAuditResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
