...
// RemediesListResponse struct for RemediesListResponse
type RemediesListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []RemedyResponse `json:"data"`
...
func (o RemediesListResponse) MarshalJSON() ([]byte, error) {
...
type NullableRemediesListResponse struct {
	value *RemediesListResponse
	isSet bool
}

func (v NullableRemediesListResponse) Get() *RemediesListResponse {
	return v.value
}

func (v *NullableRemediesListResponse) Set(val *RemediesListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemediesListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemediesListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemediesListResponse(val *RemediesListResponse) *NullableRemediesListResponse {
	return &NullableRemediesListResponse{value: val, isSet: true}
}

func (v NullableRemediesListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemediesListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
