...
// ListDataCenterResponse struct for ListDataCenterResponse
...
func (o ListDataCenterResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDataCenterResponse struct {
	value *ListDataCenterResponse
	isSet bool
}

func (v NullableListDataCenterResponse) Get() *ListDataCenterResponse {
	return v.value
}

func (v *NullableListDataCenterResponse) Set(val *ListDataCenterResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDataCenterResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDataCenterResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDataCenterResponse(val *ListDataCenterResponse) *NullableListDataCenterResponse {
	return &NullableListDataCenterResponse{value: val, isSet: true}
}

func (v NullableListDataCenterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDataCenterResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
