...
// ExtRemediesListResponse struct for ExtRemediesListResponse
type ExtRemediesListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []ExtRemedyResponse `json:"data"`
...
func (o ExtRemediesListResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtRemediesListResponse struct {
	value *ExtRemediesListResponse
	isSet bool
}

func (v NullableExtRemediesListResponse) Get() *ExtRemediesListResponse {
	return v.value
}

func (v *NullableExtRemediesListResponse) Set(val *ExtRemediesListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtRemediesListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtRemediesListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtRemediesListResponse(val *ExtRemediesListResponse) *NullableExtRemediesListResponse {
	return &NullableExtRemediesListResponse{value: val, isSet: true}
}

func (v NullableExtRemediesListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtRemediesListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
