...
// VipResponse struct for VipResponse
...
func (o VipResponse) MarshalJSON() ([]byte, error) {
...
type NullableVipResponse struct {
	value *VipResponse
	isSet bool
}

func (v NullableVipResponse) Get() *VipResponse {
	return v.value
}

func (v *NullableVipResponse) Set(val *VipResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVipResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVipResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVipResponse(val *VipResponse) *NullableVipResponse {
	return &NullableVipResponse{value: val, isSet: true}
}

func (v NullableVipResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVipResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
