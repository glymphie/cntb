...
// BaseRemedyCreateRequest struct for BaseRemedyCreateRequest
type BaseRemedyCreateRequest struct {
...
func (o BaseRemedyCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableBaseRemedyCreateRequest struct {
	value *BaseRemedyCreateRequest
	isSet bool
}

func (v NullableBaseRemedyCreateRequest) Get() *BaseRemedyCreateRequest {
	return v.value
}

func (v *NullableBaseRemedyCreateRequest) Set(val *BaseRemedyCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseRemedyCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseRemedyCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseRemedyCreateRequest(val *BaseRemedyCreateRequest) *NullableBaseRemedyCreateRequest {
	return &NullableBaseRemedyCreateRequest{value: val, isSet: true}
}

func (v NullableBaseRemedyCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseRemedyCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
