...
// FindInstanceResponse struct for FindInstanceResponse
...
func (o FindInstanceResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindInstanceResponse struct {
	value *FindInstanceResponse
	isSet bool
}

func (v NullableFindInstanceResponse) Get() *FindInstanceResponse {
	return v.value
}

func (v *NullableFindInstanceResponse) Set(val *FindInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindInstanceResponse(val *FindInstanceResponse) *NullableFindInstanceResponse {
	return &NullableFindInstanceResponse{value: val, isSet: true}
}

func (v NullableFindInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
