...
// ReinstallInstanceRequest struct for ReinstallInstanceRequest
...
func (o ReinstallInstanceRequest) MarshalJSON() ([]byte, error) {
...
type NullableReinstallInstanceRequest struct {
	value *ReinstallInstanceRequest
	isSet bool
}

func (v NullableReinstallInstanceRequest) Get() *ReinstallInstanceRequest {
	return v.value
}

func (v *NullableReinstallInstanceRequest) Set(val *ReinstallInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReinstallInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReinstallInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReinstallInstanceRequest(val *ReinstallInstanceRequest) *NullableReinstallInstanceRequest {
	return &NullableReinstallInstanceRequest{value: val, isSet: true}
}

func (v NullableReinstallInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReinstallInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
