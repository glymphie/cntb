...
// GetExtraStorage returns the ExtraStorage field value if set, zero value otherwise.
func (o *CreateInstanceAddons) GetExtraStorage() ExtraStorageRequest {
	if o == nil || o.ExtraStorage == nil {
		var ret ExtraStorageRequest
		return ret
	}
	return *o.ExtraStorage
}

// GetExtraStorageOk returns a tuple with the ExtraStorage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateInstanceAddons) GetExtraStorageOk() (*ExtraStorageRequest, bool) {
	if o == nil || o.ExtraStorage == nil {
		return nil, false
	}
	return o.ExtraStorage, true
}
...
// SetExtraStorage gets a reference to the given ExtraStorageRequest and assigns it to the ExtraStorage field.
...
// GetAddonsIds returns the AddonsIds field value if set, zero value otherwise.
func (o *CreateInstanceAddons) GetAddonsIds() []AddOnRequest {
	if o == nil || o.AddonsIds == nil {
		var ret []AddOnRequest
		return ret
	}
	return *o.AddonsIds
}

// GetAddonsIdsOk returns a tuple with the AddonsIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateInstanceAddons) GetAddonsIdsOk() (*[]AddOnRequest, bool) {
	if o == nil || o.AddonsIds == nil {
		return nil, false
	}
	return o.AddonsIds, true
}
...
// SetAddonsIds gets a reference to the given []AddOnRequest and assigns it to the AddonsIds field.
func (o *CreateInstanceAddons) SetAddonsIds(v []AddOnRequest) {
	o.AddonsIds = &v
}

func (o CreateInstanceAddons) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.PrivateNetworking != nil {
		toSerialize["privateNetworking"] = o.PrivateNetworking
	}
	if o.AdditionalIps != nil {
	...
	if o.ExtraStorage != nil {
		toSerialize["extraStorage"] = o.ExtraStorage
	}
	if o.CustomImage != nil {
		toSerialize["customImage"] = o.CustomImage
	}
	if o.AddonsIds != nil {
		toSerialize["addonsIds"] = o.AddonsIds
	}
	return json.Marshal(toSerialize)
}

type NullableCreateInstanceAddons struct {
	value *CreateInstanceAddons
	isSet bool
}

func (v NullableCreateInstanceAddons) Get() *CreateInstanceAddons {
	return v.value
}

func (v *NullableCreateInstanceAddons) Set(val *CreateInstanceAddons) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInstanceAddons) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInstanceAddons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInstanceAddons(val *CreateInstanceAddons) *NullableCreateInstanceAddons {
	return &NullableCreateInstanceAddons{value: val, isSet: true}
}

func (v NullableCreateInstanceAddons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInstanceAddons) UnmarshalJSON(src []byte) error {
	v.isSet = true
