...
// FindUserIsPasswordSetResponse struct for FindUserIsPasswordSetResponse
...
func NewFindUserIsPasswordSetResponse(data []UserIsPasswordSetResponse, links SelfLinks) *FindUserIsPasswordSetResponse {
	this := FindUserIsPasswordSetResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *FindUserIsPasswordSetResponse) GetData() []UserIsPasswordSetResponse {
	if o == nil {
		var ret []UserIsPasswordSetResponse
		return ret
	}
...
func (o FindUserIsPasswordSetResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindUserIsPasswordSetResponse struct {
	value *FindUserIsPasswordSetResponse
	isSet bool
}

func (v NullableFindUserIsPasswordSetResponse) Get() *FindUserIsPasswordSetResponse {
	return v.value
}

func (v *NullableFindUserIsPasswordSetResponse) Set(val *FindUserIsPasswordSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindUserIsPasswordSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindUserIsPasswordSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindUserIsPasswordSetResponse(val *FindUserIsPasswordSetResponse) *NullableFindUserIsPasswordSetResponse {
	return &NullableFindUserIsPasswordSetResponse{value: val, isSet: true}
}

func (v NullableFindUserIsPasswordSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindUserIsPasswordSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
