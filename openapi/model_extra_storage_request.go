...
// ExtraStorageRequest struct for ExtraStorageRequest
...
// SetNvme gets a reference to the given []string and assigns it to the Nvme field.
func (o *ExtraStorageRequest) SetNvme(v []string) {
	o.Nvme = &v
}

func (o ExtraStorageRequest) MarshalJSON() ([]byte, error) {
...
type NullableExtraStorageRequest struct {
	value *ExtraStorageRequest
	isSet bool
}

func (v NullableExtraStorageRequest) Get() *ExtraStorageRequest {
	return v.value
}

func (v *NullableExtraStorageRequest) Set(val *ExtraStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableExtraStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableExtraStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtraStorageRequest(val *ExtraStorageRequest) *NullableExtraStorageRequest {
	return &NullableExtraStorageRequest{value: val, isSet: true}
}

func (v NullableExtraStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtraStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
