...
// GenerateClientSecretResponse struct for GenerateClientSecretResponse
...
func NewGenerateClientSecretResponse(data []ClientSecretResponse, links SelfLinks) *GenerateClientSecretResponse {
	this := GenerateClientSecretResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o GenerateClientSecretResponse) MarshalJSON() ([]byte, error) {
...
type NullableGenerateClientSecretResponse struct {
	value *GenerateClientSecretResponse
	isSet bool
}

func (v NullableGenerateClientSecretResponse) Get() *GenerateClientSecretResponse {
	return v.value
}

func (v *NullableGenerateClientSecretResponse) Set(val *GenerateClientSecretResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateClientSecretResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateClientSecretResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateClientSecretResponse(val *GenerateClientSecretResponse) *NullableGenerateClientSecretResponse {
	return &NullableGenerateClientSecretResponse{value: val, isSet: true}
}

func (v NullableGenerateClientSecretResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateClientSecretResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
