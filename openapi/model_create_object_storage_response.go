...
// CreateObjectStorageResponse struct for CreateObjectStorageResponse
...
func NewCreateObjectStorageResponse(data []CreateObjectStorageResponseData, links SelfLinks) *CreateObjectStorageResponse {
	this := CreateObjectStorageResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CreateObjectStorageResponse) GetData() []CreateObjectStorageResponseData {
	if o == nil {
		var ret []CreateObjectStorageResponseData
		return ret
	}
...
func (o CreateObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateObjectStorageResponse struct {
	value *CreateObjectStorageResponse
	isSet bool
}

func (v NullableCreateObjectStorageResponse) Get() *CreateObjectStorageResponse {
	return v.value
}

func (v *NullableCreateObjectStorageResponse) Set(val *CreateObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateObjectStorageResponse(val *CreateObjectStorageResponse) *NullableCreateObjectStorageResponse {
	return &NullableCreateObjectStorageResponse{value: val, isSet: true}
}

func (v NullableCreateObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
