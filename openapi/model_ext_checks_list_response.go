...
// ExtChecksListResponse struct for ExtChecksListResponse
type ExtChecksListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []ExtCheckResponse `json:"data"`
...
func (o ExtChecksListResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtChecksListResponse struct {
	value *ExtChecksListResponse
	isSet bool
}

func (v NullableExtChecksListResponse) Get() *ExtChecksListResponse {
	return v.value
}

func (v *NullableExtChecksListResponse) Set(val *ExtChecksListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtChecksListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtChecksListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtChecksListResponse(val *ExtChecksListResponse) *NullableExtChecksListResponse {
	return &NullableExtChecksListResponse{value: val, isSet: true}
}

func (v NullableExtChecksListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtChecksListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
