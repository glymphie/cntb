...
// CreateCustomImageFailResponse struct for CreateCustomImageFailResponse
...
func NewCreateCustomImageFailResponse(message string, statusCode int32) *CreateCustomImageFailResponse {
	this := CreateCustomImageFailResponse{}
...
func (o CreateCustomImageFailResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateCustomImageFailResponse struct {
	value *CreateCustomImageFailResponse
	isSet bool
}

func (v NullableCreateCustomImageFailResponse) Get() *CreateCustomImageFailResponse {
	return v.value
}

func (v *NullableCreateCustomImageFailResponse) Set(val *CreateCustomImageFailResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCustomImageFailResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCustomImageFailResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCustomImageFailResponse(val *CreateCustomImageFailResponse) *NullableCreateCustomImageFailResponse {
	return &NullableCreateCustomImageFailResponse{value: val, isSet: true}
}

func (v NullableCreateCustomImageFailResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCustomImageFailResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
