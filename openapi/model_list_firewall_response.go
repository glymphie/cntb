...
// ListFirewallResponse struct for ListFirewallResponse
type ListFirewallResponse struct {
	...
	Data []ListFirewallResponseData `json:"data"`
...
func (o *ListFirewallResponse) GetData() []ListFirewallResponseData {
	if o == nil {
		var ret []ListFirewallResponseData
		return ret
	}
...
func (o ListFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableListFirewallResponse struct {
	value *ListFirewallResponse
	isSet bool
}

func (v NullableListFirewallResponse) Get() *ListFirewallResponse {
	return v.value
}

func (v *NullableListFirewallResponse) Set(val *ListFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFirewallResponse(val *ListFirewallResponse) *NullableListFirewallResponse {
	return &NullableListFirewallResponse{value: val, isSet: true}
}

func (v NullableListFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
