...
// ListVipAuditResponse struct for ListVipAuditResponse
...
func (o ListVipAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListVipAuditResponse struct {
	value *ListVipAuditResponse
	isSet bool
}

func (v NullableListVipAuditResponse) Get() *ListVipAuditResponse {
	return v.value
}

func (v *NullableListVipAuditResponse) Set(val *ListVipAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListVipAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListVipAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVipAuditResponse(val *ListVipAuditResponse) *NullableListVipAuditResponse {
	return &NullableListVipAuditResponse{value: val, isSet: true}
}

func (v NullableListVipAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVipAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
