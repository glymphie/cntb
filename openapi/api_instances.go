...
func (r ApiCancelInstanceRequest) CancelInstanceRequest(cancelInstanceRequest CancelInstanceRequest) ApiCancelInstanceRequest {
	r.cancelInstanceRequest = &cancelInstanceRequest
	return r
}
...
func (a *InstancesApiService) CancelInstanceExecute(r ApiCancelInstanceRequest) (CancelInstanceResponse, *_nethttp.Response, error) {
	...
	if r.cancelInstanceRequest == nil {
		return localVarReturnValue, nil, reportError("cancelInstanceRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cancelInstanceRequest
...
func (r ApiRetrieveInstancesListRequest) ProductIds(productIds string) ApiRetrieveInstancesListRequest {
...
func (a *InstancesApiService) RetrieveInstancesListExecute(r ApiRetrieveInstancesListRequest) (ListInstancesResponse, *_nethttp.Response, error) {
	...
	if r.productIds != nil {
		localVarQueryParams.Add("productIds", parameterToString(*r.productIds, ""))
	}
	if r.addOnIds != nil {
