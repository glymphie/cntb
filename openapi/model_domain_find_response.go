...
// DomainFindResponse struct for DomainFindResponse
...
func (o DomainFindResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainFindResponse struct {
	value *DomainFindResponse
	isSet bool
}

func (v NullableDomainFindResponse) Get() *DomainFindResponse {
	return v.value
}

func (v *NullableDomainFindResponse) Set(val *DomainFindResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainFindResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainFindResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainFindResponse(val *DomainFindResponse) *NullableDomainFindResponse {
	return &NullableDomainFindResponse{value: val, isSet: true}
}

func (v NullableDomainFindResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainFindResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
