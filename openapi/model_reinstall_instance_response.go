...
// ReinstallInstanceResponse struct for ReinstallInstanceResponse
...
func NewReinstallInstanceResponse(data []ReinstallInstanceResponseData, links SelfLinks) *ReinstallInstanceResponse {
	this := ReinstallInstanceResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *ReinstallInstanceResponse) GetData() []ReinstallInstanceResponseData {
	if o == nil {
		var ret []ReinstallInstanceResponseData
		return ret
	}
...
func (o ReinstallInstanceResponse) MarshalJSON() ([]byte, error) {
...
type NullableReinstallInstanceResponse struct {
	value *ReinstallInstanceResponse
	isSet bool
}

func (v NullableReinstallInstanceResponse) Get() *ReinstallInstanceResponse {
	return v.value
}

func (v *NullableReinstallInstanceResponse) Set(val *ReinstallInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReinstallInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReinstallInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReinstallInstanceResponse(val *ReinstallInstanceResponse) *NullableReinstallInstanceResponse {
	return &NullableReinstallInstanceResponse{value: val, isSet: true}
}

func (v NullableReinstallInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReinstallInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
