...
// ListAssignmentResponse struct for ListAssignmentResponse
...
func (o ListAssignmentResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAssignmentResponse struct {
	value *ListAssignmentResponse
	isSet bool
}

func (v NullableListAssignmentResponse) Get() *ListAssignmentResponse {
	return v.value
}

func (v *NullableListAssignmentResponse) Set(val *ListAssignmentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAssignmentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAssignmentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAssignmentResponse(val *ListAssignmentResponse) *NullableListAssignmentResponse {
	return &NullableListAssignmentResponse{value: val, isSet: true}
}

func (v NullableListAssignmentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAssignmentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
