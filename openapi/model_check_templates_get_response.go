...
// CheckTemplatesGetResponse struct for CheckTemplatesGetResponse
type CheckTemplatesGetResponse struct {
...
func NewCheckTemplatesGetResponse(data []CheckTemplateResponse, links SelfLinks) *CheckTemplatesGetResponse {
	this := CheckTemplatesGetResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o CheckTemplatesGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableCheckTemplatesGetResponse struct {
	value *CheckTemplatesGetResponse
	isSet bool
}

func (v NullableCheckTemplatesGetResponse) Get() *CheckTemplatesGetResponse {
	return v.value
}

func (v *NullableCheckTemplatesGetResponse) Set(val *CheckTemplatesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckTemplatesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckTemplatesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckTemplatesGetResponse(val *CheckTemplatesGetResponse) *NullableCheckTemplatesGetResponse {
	return &NullableCheckTemplatesGetResponse{value: val, isSet: true}
}

func (v NullableCheckTemplatesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckTemplatesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
