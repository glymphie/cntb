...
// DomainHandles struct for DomainHandles
type DomainHandles struct {
	// Domain's owner handle
	Owner string `json:"owner"`
	// Domain's admin handle
	Admin string `json:"admin"`
	// Domain's tech handle
	Tech string `json:"tech"`
	// Domain's zone handle
...
func (o DomainHandles) MarshalJSON() ([]byte, error) {
...
type NullableDomainHandles struct {
	value *DomainHandles
	isSet bool
}

func (v NullableDomainHandles) Get() *DomainHandles {
	return v.value
}

func (v *NullableDomainHandles) Set(val *DomainHandles) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainHandles) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainHandles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainHandles(val *DomainHandles) *NullableDomainHandles {
	return &NullableDomainHandles{value: val, isSet: true}
}

func (v NullableDomainHandles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainHandles) UnmarshalJSON(src []byte) error {
	v.isSet = true
