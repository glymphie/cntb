...
// InstanceShutdownActionResponse struct for InstanceShutdownActionResponse
...
func NewInstanceShutdownActionResponse(data []InstanceShutdownActionResponseData, links SelfLinks) *InstanceShutdownActionResponse {
	this := InstanceShutdownActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceShutdownActionResponse) GetData() []InstanceShutdownActionResponseData {
	if o == nil {
		var ret []InstanceShutdownActionResponseData
		return ret
	}
...
func (o InstanceShutdownActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceShutdownActionResponse struct {
	value *InstanceShutdownActionResponse
	isSet bool
}

func (v NullableInstanceShutdownActionResponse) Get() *InstanceShutdownActionResponse {
	return v.value
}

func (v *NullableInstanceShutdownActionResponse) Set(val *InstanceShutdownActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceShutdownActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceShutdownActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceShutdownActionResponse(val *InstanceShutdownActionResponse) *NullableInstanceShutdownActionResponse {
	return &NullableInstanceShutdownActionResponse{value: val, isSet: true}
}

func (v NullableInstanceShutdownActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceShutdownActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
