...
// PatchInstanceResponse struct for PatchInstanceResponse
...
func (o *PatchInstanceResponse) GetData() []PatchInstanceResponseData {
	if o == nil {
		var ret []PatchInstanceResponseData
		return ret
	}
...
func (o PatchInstanceResponse) MarshalJSON() ([]byte, error) {
...
type NullablePatchInstanceResponse struct {
	value *PatchInstanceResponse
	isSet bool
}

func (v NullablePatchInstanceResponse) Get() *PatchInstanceResponse {
	return v.value
}

func (v *NullablePatchInstanceResponse) Set(val *PatchInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchInstanceResponse(val *PatchInstanceResponse) *NullablePatchInstanceResponse {
	return &NullablePatchInstanceResponse{value: val, isSet: true}
}

func (v NullablePatchInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
