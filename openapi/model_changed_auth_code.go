...
// ChangedAuthCode struct for ChangedAuthCode
type ChangedAuthCode struct {
	// Flag that indicates if the auth code got changed
	Changed *bool `json:"changed,omitempty"`
	// The date when auth code got changed
...
func (o ChangedAuthCode) MarshalJSON() ([]byte, error) {
...
type NullableChangedAuthCode struct {
	value *ChangedAuthCode
	isSet bool
}

func (v NullableChangedAuthCode) Get() *ChangedAuthCode {
	return v.value
}

func (v *NullableChangedAuthCode) Set(val *ChangedAuthCode) {
	v.value = val
	v.isSet = true
}

func (v NullableChangedAuthCode) IsSet() bool {
	return v.isSet
}

func (v *NullableChangedAuthCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangedAuthCode(val *ChangedAuthCode) *NullableChangedAuthCode {
	return &NullableChangedAuthCode{value: val, isSet: true}
}

func (v NullableChangedAuthCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangedAuthCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
