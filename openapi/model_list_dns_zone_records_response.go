...
// ListDnsZoneRecordsResponse struct for ListDnsZoneRecordsResponse
type ListDnsZoneRecordsResponse struct {
	...
	Data []DnsZoneRecordResponse `json:"data"`
...
func NewListDnsZoneRecordsResponse(pagination PaginationMeta, data []DnsZoneRecordResponse, links Links) *ListDnsZoneRecordsResponse {
	this := ListDnsZoneRecordsResponse{}
...
func (o ListDnsZoneRecordsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDnsZoneRecordsResponse struct {
	value *ListDnsZoneRecordsResponse
	isSet bool
}

func (v NullableListDnsZoneRecordsResponse) Get() *ListDnsZoneRecordsResponse {
	return v.value
}

func (v *NullableListDnsZoneRecordsResponse) Set(val *ListDnsZoneRecordsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDnsZoneRecordsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDnsZoneRecordsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDnsZoneRecordsResponse(val *ListDnsZoneRecordsResponse) *NullableListDnsZoneRecordsResponse {
	return &NullableListDnsZoneRecordsResponse{value: val, isSet: true}
}

func (v NullableListDnsZoneRecordsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDnsZoneRecordsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
