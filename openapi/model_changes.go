...
func (o Changes) MarshalJSON() ([]byte, error) {
...
type NullableChanges struct {
	value *Changes
	isSet bool
}

func (v NullableChanges) Get() *Changes {
	return v.value
}

func (v *NullableChanges) Set(val *Changes) {
	v.value = val
	v.isSet = true
}

func (v NullableChanges) IsSet() bool {
	return v.isSet
}

func (v *NullableChanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChanges(val *Changes) *NullableChanges {
	return &NullableChanges{value: val, isSet: true}
}

func (v NullableChanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
