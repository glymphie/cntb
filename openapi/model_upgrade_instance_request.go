...
// UpgradeInstanceRequest struct for UpgradeInstanceRequest
...
func (o UpgradeInstanceRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpgradeInstanceRequest struct {
	value *UpgradeInstanceRequest
	isSet bool
}

func (v NullableUpgradeInstanceRequest) Get() *UpgradeInstanceRequest {
	return v.value
}

func (v *NullableUpgradeInstanceRequest) Set(val *UpgradeInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeInstanceRequest(val *UpgradeInstanceRequest) *NullableUpgradeInstanceRequest {
	return &NullableUpgradeInstanceRequest{value: val, isSet: true}
}

func (v NullableUpgradeInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
