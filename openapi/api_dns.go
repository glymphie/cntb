...
type ApiBulkDeleteDnsZoneRecordsRequest struct {
	ctx _context.Context
	ApiService *DNSApiService
	xRequestId *string
	zoneName string
	bulkDeleteDnsZoneRecordsRequest *BulkDeleteDnsZoneRecordsRequest
	xTraceId *string
}
...
func (r ApiBulkDeleteDnsZoneRecordsRequest) XRequestId(xRequestId string) ApiBulkDeleteDnsZoneRecordsRequest {
	r.xRequestId = &xRequestId
	return r
}
func (r ApiBulkDeleteDnsZoneRecordsRequest) BulkDeleteDnsZoneRecordsRequest(bulkDeleteDnsZoneRecordsRequest BulkDeleteDnsZoneRecordsRequest) ApiBulkDeleteDnsZoneRecordsRequest {
	r.bulkDeleteDnsZoneRecordsRequest = &bulkDeleteDnsZoneRecordsRequest
	return r
}
// Identifier to trace group of requests.
func (r ApiBulkDeleteDnsZoneRecordsRequest) XTraceId(xTraceId string) ApiBulkDeleteDnsZoneRecordsRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiBulkDeleteDnsZoneRecordsRequest) Execute() (ApiBulkDeleteDnsZoneRecordsResponse, *_nethttp.Response, error) {
	return r.ApiService.BulkDeleteDnsZoneRecordsExecute(r)
}

/*
BulkDeleteDnsZoneRecords Bulk delete DNS zone records

Delete multiple zone records from a DNS Zone

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param zoneName Zone name
 @return ApiBulkDeleteDnsZoneRecordsRequest
*/
func (a *DNSApiService) BulkDeleteDnsZoneRecords(ctx _context.Context, zoneName string) ApiBulkDeleteDnsZoneRecordsRequest {
	return ApiBulkDeleteDnsZoneRecordsRequest{
		ApiService: a,
		ctx: ctx,
		zoneName: zoneName,
...
//  @return ApiBulkDeleteDnsZoneRecordsResponse
func (a *DNSApiService) BulkDeleteDnsZoneRecordsExecute(r ApiBulkDeleteDnsZoneRecordsRequest) (ApiBulkDeleteDnsZoneRecordsResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ApiBulkDeleteDnsZoneRecordsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSApiService.BulkDeleteDnsZoneRecords")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/dns/zones/{zoneName}/records/bulk"
	...
	if r.bulkDeleteDnsZoneRecordsRequest == nil {
		return localVarReturnValue, nil, reportError("bulkDeleteDnsZoneRecordsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.bulkDeleteDnsZoneRecordsRequest
...
Delete a DNZ Zone's record
 ...
 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param recordId The identifier of the DNS record
 @param zoneName Zone name
 @return ApiDeleteDnsZoneRecordRequest
*/
func (a *DNSApiService) DeleteDnsZoneRecord(ctx _context.Context, recordId int64, zoneName string) ApiDeleteDnsZoneRecordRequest {
	return ApiDeleteDnsZoneRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
func (a *DNSApiService) DeleteDnsZoneRecordExecute(r ApiDeleteDnsZoneRecordRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/dns/zones/{zoneName}/records/{recordId}"
...
// Search DNS records by name, type or data
func (r ApiRetrieveDnsZoneRecordsListRequest) Search(search string) ApiRetrieveDnsZoneRecordsListRequest {
	r.search = &search
	return r
}
...
// Search PTR records by ip or data
func (r ApiRetrievePtrRecordsListRequest) Search(search string) ApiRetrievePtrRecordsListRequest {
	r.search = &search
	return r
}
...
type ApiUpdateDnsZoneRecordRequest struct {
	ctx _context.Context
	ApiService *DNSApiService
	xRequestId *string
	recordId int64
...
// [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
func (r ApiUpdateDnsZoneRecordRequest) XRequestId(xRequestId string) ApiUpdateDnsZoneRecordRequest {
	r.xRequestId = &xRequestId
	return r
}
func (r ApiUpdateDnsZoneRecordRequest) UpdateDnsZoneRecordRequest(updateDnsZoneRecordRequest UpdateDnsZoneRecordRequest) ApiUpdateDnsZoneRecordRequest {
	r.updateDnsZoneRecordRequest = &updateDnsZoneRecordRequest
	return r
}
// Identifier to trace group of requests.
func (r ApiUpdateDnsZoneRecordRequest) XTraceId(xTraceId string) ApiUpdateDnsZoneRecordRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiUpdateDnsZoneRecordRequest) Execute() (ApiDnsZoneRecordResponse, *_nethttp.Response, error) {
	return r.ApiService.UpdateDnsZoneRecordExecute(r)
}

/*
UpdateDnsZoneRecord Update DNS zone record
...
Create resource record in a zone
 ...
 @param recordId The identifier of the DNS record
 @param zoneName Zone name
 @return ApiUpdateDnsZoneRecordRequest
*/
func (a *DNSApiService) UpdateDnsZoneRecord(ctx _context.Context, recordId int64, zoneName string) ApiUpdateDnsZoneRecordRequest {
	return ApiUpdateDnsZoneRecordRequest{
		ApiService: a,
		ctx: ctx,
		recordId: recordId,
...
// Execute executes the request
//  @return ApiDnsZoneRecordResponse
func (a *DNSApiService) UpdateDnsZoneRecordExecute(r ApiUpdateDnsZoneRecordRequest) (ApiDnsZoneRecordResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSApiService.UpdateDnsZoneRecord")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.updateDnsZoneRecordRequest == nil {
		return localVarReturnValue, nil, reportError("updateDnsZoneRecordRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateDnsZoneRecordRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
