...
// PtrRecordResponse struct for PtrRecordResponse
type PtrRecordResponse struct {
	...
	// IP Address
	Ip string `json:"ip"`
	// Time to live for the PTR record in seconds
	Ttl int64 `json:"ttl"`
	// PTR
	Ptr string `json:"ptr"`
}
...
func NewPtrRecordResponse(tenantId string, customerId string, ip string, ttl int64, ptr string) *PtrRecordResponse {
	this := PtrRecordResponse{}
...
func (o *PtrRecordResponse) GetTtl() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PtrRecordResponse) GetTtlOk() (*int64, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Ttl, true
...
func (o *PtrRecordResponse) SetTtl(v int64) {
	o.Ttl = v
}
...
func (o PtrRecordResponse) MarshalJSON() ([]byte, error) {
...
type NullablePtrRecordResponse struct {
	value *PtrRecordResponse
	isSet bool
}

func (v NullablePtrRecordResponse) Get() *PtrRecordResponse {
	return v.value
}

func (v *NullablePtrRecordResponse) Set(val *PtrRecordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePtrRecordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePtrRecordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePtrRecordResponse(val *PtrRecordResponse) *NullablePtrRecordResponse {
	return &NullablePtrRecordResponse{value: val, isSet: true}
}

func (v NullablePtrRecordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePtrRecordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
