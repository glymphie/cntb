...
// CreateUserResponseData struct for CreateUserResponseData
...
func (o CreateUserResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateUserResponseData struct {
	value *CreateUserResponseData
	isSet bool
}

func (v NullableCreateUserResponseData) Get() *CreateUserResponseData {
	return v.value
}

func (v *NullableCreateUserResponseData) Set(val *CreateUserResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUserResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateUserResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateUserResponseData(val *CreateUserResponseData) *NullableCreateUserResponseData {
	return &NullableCreateUserResponseData{value: val, isSet: true}
}

func (v NullableCreateUserResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateUserResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
