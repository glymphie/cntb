...
// ApiDnsZoneRecordResponse struct for ApiDnsZoneRecordResponse
type ApiDnsZoneRecordResponse struct {
...
func (o ApiDnsZoneRecordResponse) MarshalJSON() ([]byte, error) {
...
type NullableApiDnsZoneRecordResponse struct {
	value *ApiDnsZoneRecordResponse
	isSet bool
}

func (v NullableApiDnsZoneRecordResponse) Get() *ApiDnsZoneRecordResponse {
	return v.value
}

func (v *NullableApiDnsZoneRecordResponse) Set(val *ApiDnsZoneRecordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApiDnsZoneRecordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApiDnsZoneRecordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiDnsZoneRecordResponse(val *ApiDnsZoneRecordResponse) *NullableApiDnsZoneRecordResponse {
	return &NullableApiDnsZoneRecordResponse{value: val, isSet: true}
}

func (v NullableApiDnsZoneRecordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiDnsZoneRecordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
