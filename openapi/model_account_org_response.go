...
// AccountOrgResponse struct for AccountOrgResponse
...
func (o AccountOrgResponse) MarshalJSON() ([]byte, error) {
...
type NullableAccountOrgResponse struct {
	value *AccountOrgResponse
	isSet bool
}

func (v NullableAccountOrgResponse) Get() *AccountOrgResponse {
	return v.value
}

func (v *NullableAccountOrgResponse) Set(val *AccountOrgResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountOrgResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountOrgResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountOrgResponse(val *AccountOrgResponse) *NullableAccountOrgResponse {
	return &NullableAccountOrgResponse{value: val, isSet: true}
}

func (v NullableAccountOrgResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountOrgResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
