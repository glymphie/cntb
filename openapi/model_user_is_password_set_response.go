...
// UserIsPasswordSetResponse struct for UserIsPasswordSetResponse
...
func NewUserIsPasswordSetResponse(tenantId string, customerId string, isPasswordSet bool) *UserIsPasswordSetResponse {
	this := UserIsPasswordSetResponse{}
...
// GetIsPasswordSet returns the IsPasswordSet field value
...
// GetIsPasswordSetOk returns a tuple with the IsPasswordSet field value
// and a boolean to check if the value has been set.
...
// SetIsPasswordSet sets field value
func (o *UserIsPasswordSetResponse) SetIsPasswordSet(v bool) {
	o.IsPasswordSet = v
}

func (o UserIsPasswordSetResponse) MarshalJSON() ([]byte, error) {
...
type NullableUserIsPasswordSetResponse struct {
	value *UserIsPasswordSetResponse
	isSet bool
}

func (v NullableUserIsPasswordSetResponse) Get() *UserIsPasswordSetResponse {
	return v.value
}

func (v *NullableUserIsPasswordSetResponse) Set(val *UserIsPasswordSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserIsPasswordSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserIsPasswordSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserIsPasswordSetResponse(val *UserIsPasswordSetResponse) *NullableUserIsPasswordSetResponse {
	return &NullableUserIsPasswordSetResponse{value: val, isSet: true}
}

func (v NullableUserIsPasswordSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserIsPasswordSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
