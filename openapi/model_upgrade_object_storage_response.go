...
// UpgradeObjectStorageResponse struct for UpgradeObjectStorageResponse
...
func NewUpgradeObjectStorageResponse(links SelfLinks, data []UpgradeObjectStorageResponseData) *UpgradeObjectStorageResponse {
	this := UpgradeObjectStorageResponse{}
	this.Links = links
	this.Data = data
	return &this
}
...
func (o *UpgradeObjectStorageResponse) GetData() []UpgradeObjectStorageResponseData {
	if o == nil {
		var ret []UpgradeObjectStorageResponseData
		return ret
	}
...
func (o UpgradeObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpgradeObjectStorageResponse struct {
	value *UpgradeObjectStorageResponse
	isSet bool
}

func (v NullableUpgradeObjectStorageResponse) Get() *UpgradeObjectStorageResponse {
	return v.value
}

func (v *NullableUpgradeObjectStorageResponse) Set(val *UpgradeObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeObjectStorageResponse(val *UpgradeObjectStorageResponse) *NullableUpgradeObjectStorageResponse {
	return &NullableUpgradeObjectStorageResponse{value: val, isSet: true}
}

func (v NullableUpgradeObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
