...
// PatchPrivateNetworkRequest struct for PatchPrivateNetworkRequest
...
func NewPatchPrivateNetworkRequest() *PatchPrivateNetworkRequest {
	this := PatchPrivateNetworkRequest{}
	return &this
}
...
func (o PatchPrivateNetworkRequest) MarshalJSON() ([]byte, error) {
...
type NullablePatchPrivateNetworkRequest struct {
	value *PatchPrivateNetworkRequest
	isSet bool
}

func (v NullablePatchPrivateNetworkRequest) Get() *PatchPrivateNetworkRequest {
	return v.value
}

func (v *NullablePatchPrivateNetworkRequest) Set(val *PatchPrivateNetworkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchPrivateNetworkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchPrivateNetworkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchPrivateNetworkRequest(val *PatchPrivateNetworkRequest) *NullablePatchPrivateNetworkRequest {
	return &NullablePatchPrivateNetworkRequest{value: val, isSet: true}
}

func (v NullablePatchPrivateNetworkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchPrivateNetworkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
