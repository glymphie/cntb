...
// DomainAuditResponse struct for DomainAuditResponse
type DomainAuditResponse struct {
	...
	Data []DomainAuditResponseData `json:"data"`
...
func (o *DomainAuditResponse) GetData() []DomainAuditResponseData {
	if o == nil {
		var ret []DomainAuditResponseData
		return ret
	}
...
func (o DomainAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainAuditResponse struct {
	value *DomainAuditResponse
	isSet bool
}

func (v NullableDomainAuditResponse) Get() *DomainAuditResponse {
	return v.value
}

func (v *NullableDomainAuditResponse) Set(val *DomainAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainAuditResponse(val *DomainAuditResponse) *NullableDomainAuditResponse {
	return &NullableDomainAuditResponse{value: val, isSet: true}
}

func (v NullableDomainAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
