...
// InstanceStopActionResponse struct for InstanceStopActionResponse
...
func NewInstanceStopActionResponse(data []InstanceStopActionResponseData, links SelfLinks) *InstanceStopActionResponse {
	this := InstanceStopActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceStopActionResponse) GetData() []InstanceStopActionResponseData {
	if o == nil {
		var ret []InstanceStopActionResponseData
		return ret
	}
...
func (o InstanceStopActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceStopActionResponse struct {
	value *InstanceStopActionResponse
	isSet bool
}

func (v NullableInstanceStopActionResponse) Get() *InstanceStopActionResponse {
	return v.value
}

func (v *NullableInstanceStopActionResponse) Set(val *InstanceStopActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceStopActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceStopActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceStopActionResponse(val *InstanceStopActionResponse) *NullableInstanceStopActionResponse {
	return &NullableInstanceStopActionResponse{value: val, isSet: true}
}

func (v NullableInstanceStopActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceStopActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
