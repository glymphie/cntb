...
// UpdateDnsZoneRecordRequest struct for UpdateDnsZoneRecordRequest
...
func NewUpdateDnsZoneRecordRequest(ttl float32, prio float32, type_ string, data string) *UpdateDnsZoneRecordRequest {
	this := UpdateDnsZoneRecordRequest{}
	this.Ttl = ttl
	this.Prio = prio
	this.Type = type_
	this.Data = data
...
func (o UpdateDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdateDnsZoneRecordRequest struct {
	value *UpdateDnsZoneRecordRequest
	isSet bool
}

func (v NullableUpdateDnsZoneRecordRequest) Get() *UpdateDnsZoneRecordRequest {
	return v.value
}

func (v *NullableUpdateDnsZoneRecordRequest) Set(val *UpdateDnsZoneRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDnsZoneRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDnsZoneRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDnsZoneRecordRequest(val *UpdateDnsZoneRecordRequest) *NullableUpdateDnsZoneRecordRequest {
	return &NullableUpdateDnsZoneRecordRequest{value: val, isSet: true}
}

func (v NullableUpdateDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDnsZoneRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
