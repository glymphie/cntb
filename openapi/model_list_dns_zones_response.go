...
// ListDnsZonesResponse struct for ListDnsZonesResponse
type ListDnsZonesResponse struct {
	...
	Data []DnsZoneResponse `json:"data"`
...
func (o ListDnsZonesResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDnsZonesResponse struct {
	value *ListDnsZonesResponse
	isSet bool
}

func (v NullableListDnsZonesResponse) Get() *ListDnsZonesResponse {
	return v.value
}

func (v *NullableListDnsZonesResponse) Set(val *ListDnsZonesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDnsZonesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDnsZonesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDnsZonesResponse(val *ListDnsZonesResponse) *NullableListDnsZonesResponse {
	return &NullableListDnsZonesResponse{value: val, isSet: true}
}

func (v NullableListDnsZonesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDnsZonesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
