...
// HandlePatchRequest struct for HandlePatchRequest
...
func (o HandlePatchRequest) MarshalJSON() ([]byte, error) {
...
type NullableHandlePatchRequest struct {
	value *HandlePatchRequest
	isSet bool
}

func (v NullableHandlePatchRequest) Get() *HandlePatchRequest {
	return v.value
}

func (v *NullableHandlePatchRequest) Set(val *HandlePatchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlePatchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlePatchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlePatchRequest(val *HandlePatchRequest) *NullableHandlePatchRequest {
	return &NullableHandlePatchRequest{value: val, isSet: true}
}

func (v NullableHandlePatchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlePatchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
