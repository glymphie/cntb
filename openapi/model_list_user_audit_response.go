...
// ListUserAuditResponse struct for ListUserAuditResponse
...
func (o ListUserAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListUserAuditResponse struct {
	value *ListUserAuditResponse
	isSet bool
}

func (v NullableListUserAuditResponse) Get() *ListUserAuditResponse {
	return v.value
}

func (v *NullableListUserAuditResponse) Set(val *ListUserAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListUserAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListUserAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUserAuditResponse(val *ListUserAuditResponse) *NullableListUserAuditResponse {
	return &NullableListUserAuditResponse{value: val, isSet: true}
}

func (v NullableListUserAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUserAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
