...
// ApiDnsZoneResponse struct for ApiDnsZoneResponse
type ApiDnsZoneResponse struct {
...
func (o ApiDnsZoneResponse) MarshalJSON() ([]byte, error) {
...
type NullableApiDnsZoneResponse struct {
	value *ApiDnsZoneResponse
	isSet bool
}

func (v NullableApiDnsZoneResponse) Get() *ApiDnsZoneResponse {
	return v.value
}

func (v *NullableApiDnsZoneResponse) Set(val *ApiDnsZoneResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApiDnsZoneResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApiDnsZoneResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiDnsZoneResponse(val *ApiDnsZoneResponse) *NullableApiDnsZoneResponse {
	return &NullableApiDnsZoneResponse{value: val, isSet: true}
}

func (v NullableApiDnsZoneResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiDnsZoneResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
