...
// HandleFindResponse struct for HandleFindResponse
type HandleFindResponse struct {
...
func (o HandleFindResponse) MarshalJSON() ([]byte, error) {
...
type NullableHandleFindResponse struct {
	value *HandleFindResponse
	isSet bool
}

func (v NullableHandleFindResponse) Get() *HandleFindResponse {
	return v.value
}

func (v *NullableHandleFindResponse) Set(val *HandleFindResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHandleFindResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHandleFindResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandleFindResponse(val *HandleFindResponse) *NullableHandleFindResponse {
	return &NullableHandleFindResponse{value: val, isSet: true}
}

func (v NullableHandleFindResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandleFindResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
