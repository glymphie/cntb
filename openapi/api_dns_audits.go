...
func (a *DNSAuditsApiService) RetrieveDnsAuditsListExecute(r ApiRetrieveDnsAuditsListRequest) (ZoneAuditResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/dns/zones/audits"
...
type ApiRetrieveRecordAuditsListRequest struct {
	ctx _context.Context
	ApiService *DNSAuditsApiService
	xRequestId *string
	xTraceId *string
...
// [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
func (r ApiRetrieveRecordAuditsListRequest) XRequestId(xRequestId string) ApiRetrieveRecordAuditsListRequest {
	r.xRequestId = &xRequestId
	return r
}
// Identifier to trace group of requests.
func (r ApiRetrieveRecordAuditsListRequest) XTraceId(xTraceId string) ApiRetrieveRecordAuditsListRequest {
	r.xTraceId = &xTraceId
	return r
}
// Number of page to be fetched.
func (r ApiRetrieveRecordAuditsListRequest) Page(page int64) ApiRetrieveRecordAuditsListRequest {
	r.page = &page
	return r
}
// Number of elements per page.
func (r ApiRetrieveRecordAuditsListRequest) Size(size int64) ApiRetrieveRecordAuditsListRequest {
	r.size = &size
	return r
}
// Specify fields and ordering (ASC for ascending, DESC for descending) in following format &#x60;field:ASC|DESC&#x60;.
func (r ApiRetrieveRecordAuditsListRequest) OrderBy(orderBy []string) ApiRetrieveRecordAuditsListRequest {
	r.orderBy = &orderBy
	return r
}
// The identifier of the Zone record
func (r ApiRetrieveRecordAuditsListRequest) RecordId(recordId int64) ApiRetrieveRecordAuditsListRequest {
	r.recordId = &recordId
	return r
}
// The requestId of the API call which led to the change.
func (r ApiRetrieveRecordAuditsListRequest) RequestId(requestId string) ApiRetrieveRecordAuditsListRequest {
	r.requestId = &requestId
	return r
}
// UserId of the user which led to the change.
func (r ApiRetrieveRecordAuditsListRequest) ChangedBy(changedBy string) ApiRetrieveRecordAuditsListRequest {
	r.changedBy = &changedBy
	return r
}
// Start of search time range.
func (r ApiRetrieveRecordAuditsListRequest) StartDate(startDate string) ApiRetrieveRecordAuditsListRequest {
	r.startDate = &startDate
	return r
}
// End of search time range.
func (r ApiRetrieveRecordAuditsListRequest) EndDate(endDate string) ApiRetrieveRecordAuditsListRequest {
	r.endDate = &endDate
	return r
}

func (r ApiRetrieveRecordAuditsListRequest) Execute() (RecordAuditResponse, *_nethttp.Response, error) {
	return r.ApiService.RetrieveRecordAuditsListExecute(r)
}

/*
RetrieveRecordAuditsList List history about your DNS Records (audit)

List and filter the history of changes made to your DNS Records.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRetrieveRecordAuditsListRequest
*/
func (a *DNSAuditsApiService) RetrieveRecordAuditsList(ctx _context.Context) ApiRetrieveRecordAuditsListRequest {
	return ApiRetrieveRecordAuditsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RecordAuditResponse
func (a *DNSAuditsApiService) RetrieveRecordAuditsListExecute(r ApiRetrieveRecordAuditsListRequest) (RecordAuditResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  RecordAuditResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSAuditsApiService.RetrieveRecordAuditsList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/dns/records/audits"
