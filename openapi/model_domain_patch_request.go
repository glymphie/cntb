...
// DomainPatchRequest struct for DomainPatchRequest
type DomainPatchRequest struct {
	// Nameservers
	Nameservers *[]Nameserver `json:"nameservers,omitempty"`
	// The handles of the domain
	Handles *DomainHandles `json:"handles,omitempty"`
}
...
// SetHandles gets a reference to the given DomainHandles and assigns it to the Handles field.
