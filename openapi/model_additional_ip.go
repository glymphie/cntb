...
func (o AdditionalIp) MarshalJSON() ([]byte, error) {
...
type NullableAdditionalIp struct {
	value *AdditionalIp
	isSet bool
}

func (v NullableAdditionalIp) Get() *AdditionalIp {
	return v.value
}

func (v *NullableAdditionalIp) Set(val *AdditionalIp) {
	v.value = val
	v.isSet = true
}

func (v NullableAdditionalIp) IsSet() bool {
	return v.isSet
}

func (v *NullableAdditionalIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdditionalIp(val *AdditionalIp) *NullableAdditionalIp {
	return &NullableAdditionalIp{value: val, isSet: true}
}

func (v NullableAdditionalIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdditionalIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
