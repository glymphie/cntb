...
// CheckCollectionTemplatesCheckTemplates struct for CheckCollectionTemplatesCheckTemplates
type CheckCollectionTemplatesCheckTemplates struct {
	// Id of the check template
	CheckTemplateId float32 `json:"checkTemplateId"`
	// Can this check template be run in parallel with other checks
	RunConcurrent bool `json:"runConcurrent"`
	// Will errors be ignored when running this check template
	IgnoreErrors bool `json:"ignoreErrors"`
	// Nested check templates
	CheckTemplates *[]CheckCollectionTemplatesCheckTemplates `json:"checkTemplates,omitempty"`
}
...
func NewCheckCollectionTemplatesCheckTemplates(checkTemplateId float32, runConcurrent bool, ignoreErrors bool) *CheckCollectionTemplatesCheckTemplates {
	this := CheckCollectionTemplatesCheckTemplates{}
...
// GetRunConcurrent returns the RunConcurrent field value
func (o *CheckCollectionTemplatesCheckTemplates) GetRunConcurrent() bool {
	...
	return o.RunConcurrent
}

// GetRunConcurrentOk returns a tuple with the RunConcurrent field value
// and a boolean to check if the value has been set.
func (o *CheckCollectionTemplatesCheckTemplates) GetRunConcurrentOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.RunConcurrent, true
}

// SetRunConcurrent sets field value
...
// GetIgnoreErrorsOk returns a tuple with the IgnoreErrors field value
// and a boolean to check if the value has been set.
...
// GetCheckTemplates returns the CheckTemplates field value if set, zero value otherwise.
func (o *CheckCollectionTemplatesCheckTemplates) GetCheckTemplates() []CheckCollectionTemplatesCheckTemplates {
	if o == nil || o.CheckTemplates == nil {
		var ret []CheckCollectionTemplatesCheckTemplates
		return ret
	}
	return *o.CheckTemplates
}

// GetCheckTemplatesOk returns a tuple with the CheckTemplates field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCheckTemplates gets a reference to the given []CheckCollectionTemplatesCheckTemplates and assigns it to the CheckTemplates field.
func (o *CheckCollectionTemplatesCheckTemplates) SetCheckTemplates(v []CheckCollectionTemplatesCheckTemplates) {
	o.CheckTemplates = &v
}

func (o CheckCollectionTemplatesCheckTemplates) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["checkTemplateId"] = o.CheckTemplateId
	}
	if true {
		toSerialize["runConcurrent"] = o.RunConcurrent
	}
	if true {
		toSerialize["ignoreErrors"] = o.IgnoreErrors
	}
	if o.CheckTemplates != nil {
		toSerialize["checkTemplates"] = o.CheckTemplates
	}
	return json.Marshal(toSerialize)
}

type NullableCheckCollectionTemplatesCheckTemplates struct {
	value *CheckCollectionTemplatesCheckTemplates
	isSet bool
}

func (v NullableCheckCollectionTemplatesCheckTemplates) Get() *CheckCollectionTemplatesCheckTemplates {
	return v.value
}

func (v *NullableCheckCollectionTemplatesCheckTemplates) Set(val *CheckCollectionTemplatesCheckTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionTemplatesCheckTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionTemplatesCheckTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionTemplatesCheckTemplates(val *CheckCollectionTemplatesCheckTemplates) *NullableCheckCollectionTemplatesCheckTemplates {
	return &NullableCheckCollectionTemplatesCheckTemplates{value: val, isSet: true}
}

func (v NullableCheckCollectionTemplatesCheckTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionTemplatesCheckTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
