...
// ListApiPermissionResponse struct for ListApiPermissionResponse
...
func NewListApiPermissionResponse(data []ApiPermissionsResponse, links Links) *ListApiPermissionResponse {
	this := ListApiPermissionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *ListApiPermissionResponse) GetData() []ApiPermissionsResponse {
	if o == nil {
		var ret []ApiPermissionsResponse
		return ret
	}
...
func (o ListApiPermissionResponse) MarshalJSON() ([]byte, error) {
...
type NullableListApiPermissionResponse struct {
	value *ListApiPermissionResponse
	isSet bool
}

func (v NullableListApiPermissionResponse) Get() *ListApiPermissionResponse {
	return v.value
}

func (v *NullableListApiPermissionResponse) Set(val *ListApiPermissionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListApiPermissionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListApiPermissionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListApiPermissionResponse(val *ListApiPermissionResponse) *NullableListApiPermissionResponse {
	return &NullableListApiPermissionResponse{value: val, isSet: true}
}

func (v NullableListApiPermissionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListApiPermissionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
