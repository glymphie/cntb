...
// ListRoleAuditResponse struct for ListRoleAuditResponse
...
func (o ListRoleAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListRoleAuditResponse struct {
	value *ListRoleAuditResponse
	isSet bool
}

func (v NullableListRoleAuditResponse) Get() *ListRoleAuditResponse {
	return v.value
}

func (v *NullableListRoleAuditResponse) Set(val *ListRoleAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListRoleAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListRoleAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRoleAuditResponse(val *ListRoleAuditResponse) *NullableListRoleAuditResponse {
	return &NullableListRoleAuditResponse{value: val, isSet: true}
}

func (v NullableListRoleAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRoleAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
