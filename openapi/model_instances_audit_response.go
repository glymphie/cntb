...
// InstancesAuditResponse struct for InstancesAuditResponse
...
func (o InstancesAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstancesAuditResponse struct {
	value *InstancesAuditResponse
	isSet bool
}

func (v NullableInstancesAuditResponse) Get() *InstancesAuditResponse {
	return v.value
}

func (v *NullableInstancesAuditResponse) Set(val *InstancesAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesAuditResponse(val *InstancesAuditResponse) *NullableInstancesAuditResponse {
	return &NullableInstancesAuditResponse{value: val, isSet: true}
}

func (v NullableInstancesAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
