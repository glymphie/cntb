...
// UsersObjectStorageCredentialsApiService UsersObjectStorageCredentialsApi service
type UsersObjectStorageCredentialsApiService service

type ApiGetObjectStorageCredentialsRequest struct {
	ctx _context.Context
	ApiService *UsersObjectStorageCredentialsApiService
	xRequestId *string
	userId string
...
*/
func (a *UsersObjectStorageCredentialsApiService) GetObjectStorageCredentials(ctx _context.Context, userId string, objectStorageId string, credentialId int64) ApiGetObjectStorageCredentialsRequest {
	return ApiGetObjectStorageCredentialsRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UsersObjectStorageCredentialsApiService) GetObjectStorageCredentialsExecute(r ApiGetObjectStorageCredentialsRequest) (FindCredentialResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersObjectStorageCredentialsApiService.GetObjectStorageCredentials")
	if err != nil {
...
*/
func (a *UsersObjectStorageCredentialsApiService) ListObjectStorageCredentials(ctx _context.Context, userId string) ApiListObjectStorageCredentialsRequest {
	return ApiListObjectStorageCredentialsRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
func (a *UsersObjectStorageCredentialsApiService) ListObjectStorageCredentialsExecute(r ApiListObjectStorageCredentialsRequest) (ListCredentialResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersObjectStorageCredentialsApiService.ListObjectStorageCredentials")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *UsersObjectStorageCredentialsApiService) RegenerateObjectStorageCredentials(ctx _context.Context, userId string, objectStorageId string, credentialId int64) ApiRegenerateObjectStorageCredentialsRequest {
	return ApiRegenerateObjectStorageCredentialsRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
//  @return FindCredentialResponse
func (a *UsersObjectStorageCredentialsApiService) RegenerateObjectStorageCredentialsExecute(r ApiRegenerateObjectStorageCredentialsRequest) (FindCredentialResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersObjectStorageCredentialsApiService.RegenerateObjectStorageCredentials")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
