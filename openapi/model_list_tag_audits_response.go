...
// ListTagAuditsResponse struct for ListTagAuditsResponse
...
func (o ListTagAuditsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTagAuditsResponse struct {
	value *ListTagAuditsResponse
	isSet bool
}

func (v NullableListTagAuditsResponse) Get() *ListTagAuditsResponse {
	return v.value
}

func (v *NullableListTagAuditsResponse) Set(val *ListTagAuditsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTagAuditsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTagAuditsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTagAuditsResponse(val *ListTagAuditsResponse) *NullableListTagAuditsResponse {
	return &NullableListTagAuditsResponse{value: val, isSet: true}
}

func (v NullableListTagAuditsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTagAuditsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
