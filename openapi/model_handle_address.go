...
// HandleAddress struct for HandleAddress
type HandleAddress struct {
	// Street
...
func (o HandleAddress) MarshalJSON() ([]byte, error) {
...
type NullableHandleAddress struct {
	value *HandleAddress
	isSet bool
}

func (v NullableHandleAddress) Get() *HandleAddress {
	return v.value
}

func (v *NullableHandleAddress) Set(val *HandleAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableHandleAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableHandleAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandleAddress(val *HandleAddress) *NullableHandleAddress {
	return &NullableHandleAddress{value: val, isSet: true}
}

func (v NullableHandleAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandleAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
