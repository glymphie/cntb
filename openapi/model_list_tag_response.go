...
// ListTagResponse struct for ListTagResponse
...
func (o ListTagResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTagResponse struct {
	value *ListTagResponse
	isSet bool
}

func (v NullableListTagResponse) Get() *ListTagResponse {
	return v.value
}

func (v *NullableListTagResponse) Set(val *ListTagResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTagResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTagResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTagResponse(val *ListTagResponse) *NullableListTagResponse {
	return &NullableListTagResponse{value: val, isSet: true}
}

func (v NullableListTagResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTagResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
