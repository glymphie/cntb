...
// UpdatePtrRecordRequest struct for UpdatePtrRecordRequest
...
func (o UpdatePtrRecordRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdatePtrRecordRequest struct {
	value *UpdatePtrRecordRequest
	isSet bool
}

func (v NullableUpdatePtrRecordRequest) Get() *UpdatePtrRecordRequest {
	return v.value
}

func (v *NullableUpdatePtrRecordRequest) Set(val *UpdatePtrRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePtrRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePtrRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePtrRecordRequest(val *UpdatePtrRecordRequest) *NullableUpdatePtrRecordRequest {
	return &NullableUpdatePtrRecordRequest{value: val, isSet: true}
}

func (v NullableUpdatePtrRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePtrRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
