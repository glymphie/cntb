...
// RecordAuditResponseData struct for RecordAuditResponseData
type RecordAuditResponseData struct {
	...
	// The identifier of the Zone recordd
...
func (o RecordAuditResponseData) MarshalJSON() ([]byte, error) {
...
type NullableRecordAuditResponseData struct {
	value *RecordAuditResponseData
	isSet bool
}

func (v NullableRecordAuditResponseData) Get() *RecordAuditResponseData {
	return v.value
}

func (v *NullableRecordAuditResponseData) Set(val *RecordAuditResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordAuditResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordAuditResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordAuditResponseData(val *RecordAuditResponseData) *NullableRecordAuditResponseData {
	return &NullableRecordAuditResponseData{value: val, isSet: true}
}

func (v NullableRecordAuditResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordAuditResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
