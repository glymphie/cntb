...
func (o IpV6) MarshalJSON() ([]byte, error) {
...
type NullableIpV6 struct {
	value *IpV6
	isSet bool
}

func (v NullableIpV6) Get() *IpV6 {
	return v.value
}

func (v *NullableIpV6) Set(val *IpV6) {
	v.value = val
	v.isSet = true
}

func (v NullableIpV6) IsSet() bool {
	return v.isSet
}

func (v *NullableIpV6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpV6(val *IpV6) *NullableIpV6 {
	return &NullableIpV6{value: val, isSet: true}
}

func (v NullableIpV6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpV6) UnmarshalJSON(src []byte) error {
	v.isSet = true
