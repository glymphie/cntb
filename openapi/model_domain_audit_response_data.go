...
// DomainAuditResponseData struct for DomainAuditResponseData
type DomainAuditResponseData struct {
...
func (o DomainAuditResponseData) MarshalJSON() ([]byte, error) {
...
type NullableDomainAuditResponseData struct {
	value *DomainAuditResponseData
	isSet bool
}

func (v NullableDomainAuditResponseData) Get() *DomainAuditResponseData {
	return v.value
}

func (v *NullableDomainAuditResponseData) Set(val *DomainAuditResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainAuditResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainAuditResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainAuditResponseData(val *DomainAuditResponseData) *NullableDomainAuditResponseData {
	return &NullableDomainAuditResponseData{value: val, isSet: true}
}

func (v NullableDomainAuditResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainAuditResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
