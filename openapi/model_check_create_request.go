...
// CheckCreateRequest struct for CheckCreateRequest
...
func (o CheckCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableCheckCreateRequest struct {
	value *CheckCreateRequest
	isSet bool
}

func (v NullableCheckCreateRequest) Get() *CheckCreateRequest {
	return v.value
}

func (v *NullableCheckCreateRequest) Set(val *CheckCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCreateRequest(val *CheckCreateRequest) *NullableCheckCreateRequest {
	return &NullableCheckCreateRequest{value: val, isSet: true}
}

func (v NullableCheckCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
