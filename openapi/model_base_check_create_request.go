...
// BaseCheckCreateRequest struct for BaseCheckCreateRequest
type BaseCheckCreateRequest struct {
	...
	// Check Collection for this check
	CheckCollectionId *float32 `json:"checkCollectionId,omitempty"`
}
...
// GetCheckCollectionId returns the CheckCollectionId field value if set, zero value otherwise.
func (o *BaseCheckCreateRequest) GetCheckCollectionId() float32 {
	if o == nil || o.CheckCollectionId == nil {
		var ret float32
		return ret
	}
...
// GetCheckCollectionIdOk returns a tuple with the CheckCollectionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCheckCollectionId gets a reference to the given float32 and assigns it to the CheckCollectionId field.
func (o *BaseCheckCreateRequest) SetCheckCollectionId(v float32) {
	o.CheckCollectionId = &v
}

func (o BaseCheckCreateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.CheckCollectionId != nil {
		toSerialize["checkCollectionId"] = o.CheckCollectionId
	}
	return json.Marshal(toSerialize)
}

type NullableBaseCheckCreateRequest struct {
	value *BaseCheckCreateRequest
	isSet bool
}

func (v NullableBaseCheckCreateRequest) Get() *BaseCheckCreateRequest {
	return v.value
}

func (v *NullableBaseCheckCreateRequest) Set(val *BaseCheckCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseCheckCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseCheckCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseCheckCreateRequest(val *BaseCheckCreateRequest) *NullableBaseCheckCreateRequest {
	return &NullableBaseCheckCreateRequest{value: val, isSet: true}
}

func (v NullableBaseCheckCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseCheckCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
