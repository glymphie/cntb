...
// FindSecretResponse struct for FindSecretResponse
...
func (o FindSecretResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindSecretResponse struct {
	value *FindSecretResponse
	isSet bool
}

func (v NullableFindSecretResponse) Get() *FindSecretResponse {
	return v.value
}

func (v *NullableFindSecretResponse) Set(val *FindSecretResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindSecretResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindSecretResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindSecretResponse(val *FindSecretResponse) *NullableFindSecretResponse {
	return &NullableFindSecretResponse{value: val, isSet: true}
}

func (v NullableFindSecretResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindSecretResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
