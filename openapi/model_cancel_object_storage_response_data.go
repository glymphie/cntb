...
// CancelObjectStorageResponseData struct for CancelObjectStorageResponseData
...
type NullableCancelObjectStorageResponseData struct {
	value *CancelObjectStorageResponseData
	isSet bool
}

func (v NullableCancelObjectStorageResponseData) Get() *CancelObjectStorageResponseData {
	return v.value
}

func (v *NullableCancelObjectStorageResponseData) Set(val *CancelObjectStorageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelObjectStorageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelObjectStorageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelObjectStorageResponseData(val *CancelObjectStorageResponseData) *NullableCancelObjectStorageResponseData {
	return &NullableCancelObjectStorageResponseData{value: val, isSet: true}
}

func (v NullableCancelObjectStorageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelObjectStorageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
