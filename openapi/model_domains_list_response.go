...
// DomainsListResponse struct for DomainsListResponse
...
func (o DomainsListResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainsListResponse struct {
	value *DomainsListResponse
	isSet bool
}

func (v NullableDomainsListResponse) Get() *DomainsListResponse {
	return v.value
}

func (v *NullableDomainsListResponse) Set(val *DomainsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainsListResponse(val *DomainsListResponse) *NullableDomainsListResponse {
	return &NullableDomainsListResponse{value: val, isSet: true}
}

func (v NullableDomainsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
