...
// InstancesActionsAuditResponse struct for InstancesActionsAuditResponse
...
func NewInstancesActionsAuditResponse(id int64, action string, timestamp time.Time, tenantId string, customerId string, changedBy string, username string, requestId string, traceId string, instanceId int64) *InstancesActionsAuditResponse {
	this := InstancesActionsAuditResponse{}
	this.Id = id
	this.Action = action
...
func (o InstancesActionsAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstancesActionsAuditResponse struct {
	value *InstancesActionsAuditResponse
	isSet bool
}

func (v NullableInstancesActionsAuditResponse) Get() *InstancesActionsAuditResponse {
	return v.value
}

func (v *NullableInstancesActionsAuditResponse) Set(val *InstancesActionsAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesActionsAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesActionsAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesActionsAuditResponse(val *InstancesActionsAuditResponse) *NullableInstancesActionsAuditResponse {
	return &NullableInstancesActionsAuditResponse{value: val, isSet: true}
}

func (v NullableInstancesActionsAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesActionsAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
