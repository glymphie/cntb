...
// ExtChecksGetResponse struct for ExtChecksGetResponse
type ExtChecksGetResponse struct {
...
func (o ExtChecksGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtChecksGetResponse struct {
	value *ExtChecksGetResponse
	isSet bool
}

func (v NullableExtChecksGetResponse) Get() *ExtChecksGetResponse {
	return v.value
}

func (v *NullableExtChecksGetResponse) Set(val *ExtChecksGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtChecksGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtChecksGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtChecksGetResponse(val *ExtChecksGetResponse) *NullableExtChecksGetResponse {
	return &NullableExtChecksGetResponse{value: val, isSet: true}
}

func (v NullableExtChecksGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtChecksGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
