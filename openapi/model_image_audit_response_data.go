...
// ImageAuditResponseData struct for ImageAuditResponseData
...
func (o ImageAuditResponseData) MarshalJSON() ([]byte, error) {
...
type NullableImageAuditResponseData struct {
	value *ImageAuditResponseData
	isSet bool
}

func (v NullableImageAuditResponseData) Get() *ImageAuditResponseData {
	return v.value
}

func (v *NullableImageAuditResponseData) Set(val *ImageAuditResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableImageAuditResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableImageAuditResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageAuditResponseData(val *ImageAuditResponseData) *NullableImageAuditResponseData {
	return &NullableImageAuditResponseData{value: val, isSet: true}
}

func (v NullableImageAuditResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageAuditResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
