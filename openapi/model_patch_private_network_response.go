...
// PatchPrivateNetworkResponse struct for PatchPrivateNetworkResponse
...
func NewPatchPrivateNetworkResponse(data []PrivateNetworkResponse, links SelfLinks) *PatchPrivateNetworkResponse {
	this := PatchPrivateNetworkResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o PatchPrivateNetworkResponse) MarshalJSON() ([]byte, error) {
...
type NullablePatchPrivateNetworkResponse struct {
	value *PatchPrivateNetworkResponse
	isSet bool
}

func (v NullablePatchPrivateNetworkResponse) Get() *PatchPrivateNetworkResponse {
	return v.value
}

func (v *NullablePatchPrivateNetworkResponse) Set(val *PatchPrivateNetworkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchPrivateNetworkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchPrivateNetworkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchPrivateNetworkResponse(val *PatchPrivateNetworkResponse) *NullablePatchPrivateNetworkResponse {
	return &NullablePatchPrivateNetworkResponse{value: val, isSet: true}
}

func (v NullablePatchPrivateNetworkResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchPrivateNetworkResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
