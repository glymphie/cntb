...
// ListInstancesActionsAuditResponse struct for ListInstancesActionsAuditResponse
...
func NewListInstancesActionsAuditResponse(pagination PaginationMeta, data []InstancesActionsAuditResponse, links Links) *ListInstancesActionsAuditResponse {
	this := ListInstancesActionsAuditResponse{}
...
func (o *ListInstancesActionsAuditResponse) GetData() []InstancesActionsAuditResponse {
	if o == nil {
		var ret []InstancesActionsAuditResponse
		return ret
	}
...
func (o ListInstancesActionsAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListInstancesActionsAuditResponse struct {
	value *ListInstancesActionsAuditResponse
	isSet bool
}

func (v NullableListInstancesActionsAuditResponse) Get() *ListInstancesActionsAuditResponse {
	return v.value
}

func (v *NullableListInstancesActionsAuditResponse) Set(val *ListInstancesActionsAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListInstancesActionsAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListInstancesActionsAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInstancesActionsAuditResponse(val *ListInstancesActionsAuditResponse) *NullableListInstancesActionsAuditResponse {
	return &NullableListInstancesActionsAuditResponse{value: val, isSet: true}
}

func (v NullableListInstancesActionsAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInstancesActionsAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
