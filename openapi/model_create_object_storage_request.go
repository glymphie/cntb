...
func (o *CreateObjectStorageRequest) GetAutoScaling() AutoScalingTypeRequest {
	if o == nil || o.AutoScaling == nil {
		var ret AutoScalingTypeRequest
		return ret
	}
...
// SetAutoScaling gets a reference to the given AutoScalingTypeRequest and assigns it to the AutoScaling field.
...
type NullableCreateObjectStorageRequest struct {
	value *CreateObjectStorageRequest
	isSet bool
}

func (v NullableCreateObjectStorageRequest) Get() *CreateObjectStorageRequest {
	return v.value
}

func (v *NullableCreateObjectStorageRequest) Set(val *CreateObjectStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateObjectStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateObjectStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateObjectStorageRequest(val *CreateObjectStorageRequest) *NullableCreateObjectStorageRequest {
	return &NullableCreateObjectStorageRequest{value: val, isSet: true}
}

func (v NullableCreateObjectStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateObjectStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
