...
// FindObjectStorageResponse struct for FindObjectStorageResponse
...
func NewFindObjectStorageResponse(data []ObjectStorageResponse, links SelfLinks) *FindObjectStorageResponse {
	this := FindObjectStorageResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o FindObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindObjectStorageResponse struct {
	value *FindObjectStorageResponse
	isSet bool
}

func (v NullableFindObjectStorageResponse) Get() *FindObjectStorageResponse {
	return v.value
}

func (v *NullableFindObjectStorageResponse) Set(val *FindObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindObjectStorageResponse(val *FindObjectStorageResponse) *NullableFindObjectStorageResponse {
	return &NullableFindObjectStorageResponse{value: val, isSet: true}
}

func (v NullableFindObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
