...
type InstanceDetails struct {
	// Instance id which is assigned to firewall
	...
	// Slug of the region where the instance is located.
	RegionSlug string `json:"regionSlug"`
	// Name of the region where the instance is located.
	RegionName string `json:"regionName"`
	// Slug of the data center where the instance is located.
	DataCenterSlug string `json:"dataCenterSlug"`
	// Name of the data center where the instance is located.
...
func NewInstanceDetails(instanceId int64, displayName string, name string, productId string, ipConfig IpConfig1, regionSlug string, regionName string, dataCenterSlug string, dataCenterName string) *InstanceDetails {
	...
	this.DataCenterSlug = dataCenterSlug
...
// GetDataCenterSlug returns the DataCenterSlug field value
func (o *InstanceDetails) GetDataCenterSlug() string {
	...
	return o.DataCenterSlug
}

// GetDataCenterSlugOk returns a tuple with the DataCenterSlug field value
// and a boolean to check if the value has been set.
func (o *InstanceDetails) GetDataCenterSlugOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.DataCenterSlug, true
}

// SetDataCenterSlug sets field value
...
func (o InstanceDetails) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["dataCenterSlug"] = o.DataCenterSlug
	}
	if true {
