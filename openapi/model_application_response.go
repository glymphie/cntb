...
// GetApplicationConfig returns the ApplicationConfig field value
...
func (o ApplicationResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["applicationConfig"] = o.ApplicationConfig
	}
	if true {
