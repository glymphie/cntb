...
// CancelInstanceResponse struct for CancelInstanceResponse
...
func (o *CancelInstanceResponse) GetData() []CancelInstanceResponseData {
	if o == nil {
		var ret []CancelInstanceResponseData
		return ret
	}
...
func (o CancelInstanceResponse) MarshalJSON() ([]byte, error) {
...
type NullableCancelInstanceResponse struct {
	value *CancelInstanceResponse
	isSet bool
}

func (v NullableCancelInstanceResponse) Get() *CancelInstanceResponse {
	return v.value
}

func (v *NullableCancelInstanceResponse) Set(val *CancelInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelInstanceResponse(val *CancelInstanceResponse) *NullableCancelInstanceResponse {
	return &NullableCancelInstanceResponse{value: val, isSet: true}
}

func (v NullableCancelInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
