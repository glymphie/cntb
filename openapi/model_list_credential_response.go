...
func (o ListCredentialResponse) MarshalJSON() ([]byte, error) {
...
type NullableListCredentialResponse struct {
	value *ListCredentialResponse
	isSet bool
}

func (v NullableListCredentialResponse) Get() *ListCredentialResponse {
	return v.value
}

func (v *NullableListCredentialResponse) Set(val *ListCredentialResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListCredentialResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListCredentialResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCredentialResponse(val *ListCredentialResponse) *NullableListCredentialResponse {
	return &NullableListCredentialResponse{value: val, isSet: true}
}

func (v NullableListCredentialResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCredentialResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
