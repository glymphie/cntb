...
// FindVipResponse struct for FindVipResponse
...
func (o FindVipResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindVipResponse struct {
	value *FindVipResponse
	isSet bool
}

func (v NullableFindVipResponse) Get() *FindVipResponse {
	return v.value
}

func (v *NullableFindVipResponse) Set(val *FindVipResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindVipResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindVipResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindVipResponse(val *FindVipResponse) *NullableFindVipResponse {
	return &NullableFindVipResponse{value: val, isSet: true}
}

func (v NullableFindVipResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindVipResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
