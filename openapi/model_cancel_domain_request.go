...
// CancelDomainRequest struct for CancelDomainRequest
type CancelDomainRequest struct {
	// Reason for cancelling an domain
	Reason *string `json:"reason,omitempty"`
	// Reason Text when `Other` reason got selected while cancelling an domain
...
func (o CancelDomainRequest) MarshalJSON() ([]byte, error) {
...
type NullableCancelDomainRequest struct {
	value *CancelDomainRequest
	isSet bool
}

func (v NullableCancelDomainRequest) Get() *CancelDomainRequest {
	return v.value
}

func (v *NullableCancelDomainRequest) Set(val *CancelDomainRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelDomainRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelDomainRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelDomainRequest(val *CancelDomainRequest) *NullableCancelDomainRequest {
	return &NullableCancelDomainRequest{value: val, isSet: true}
}

func (v NullableCancelDomainRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelDomainRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
