...
func (o *UpdateTagRequest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateTagRequest) GetDescriptionOk() (*string, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
func (o *UpdateTagRequest) HasDescription() bool {
	if o != nil && o.Description != nil {
		return true
	}
...
func (o *UpdateTagRequest) SetDescription(v string) {
	o.Description = &v
}
