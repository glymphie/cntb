...
// ListObjectStorageAuditResponse struct for ListObjectStorageAuditResponse
...
func NewListObjectStorageAuditResponse(pagination PaginationMeta, data []ObjectStorageAuditResponse, links Links) *ListObjectStorageAuditResponse {
	this := ListObjectStorageAuditResponse{}
...
func (o *ListObjectStorageAuditResponse) GetData() []ObjectStorageAuditResponse {
	if o == nil {
		var ret []ObjectStorageAuditResponse
		return ret
	}
...
func (o ListObjectStorageAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListObjectStorageAuditResponse struct {
	value *ListObjectStorageAuditResponse
	isSet bool
}

func (v NullableListObjectStorageAuditResponse) Get() *ListObjectStorageAuditResponse {
	return v.value
}

func (v *NullableListObjectStorageAuditResponse) Set(val *ListObjectStorageAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListObjectStorageAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListObjectStorageAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListObjectStorageAuditResponse(val *ListObjectStorageAuditResponse) *NullableListObjectStorageAuditResponse {
	return &NullableListObjectStorageAuditResponse{value: val, isSet: true}
}

func (v NullableListObjectStorageAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListObjectStorageAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
