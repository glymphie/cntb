...
// DnsZoneRecordResponse struct for DnsZoneRecordResponse
type DnsZoneRecordResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// RecordId
	RecordId float32 `json:"recordId"`
...
func NewDnsZoneRecordResponse(tenantId string, customerId string, recordId float32, name string, type_ string, ttl float32, prio float32, data string, port float32, weight float32, flag float32, tag string) *DnsZoneRecordResponse {
	this := DnsZoneRecordResponse{}
...
func (o *DnsZoneRecordResponse) GetRecordId() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsZoneRecordResponse) GetRecordIdOk() (*float32, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *DnsZoneRecordResponse) SetRecordId(v float32) {
	o.RecordId = v
}
...
func (o DnsZoneRecordResponse) MarshalJSON() ([]byte, error) {
...
type NullableDnsZoneRecordResponse struct {
	value *DnsZoneRecordResponse
	isSet bool
}

func (v NullableDnsZoneRecordResponse) Get() *DnsZoneRecordResponse {
	return v.value
}

func (v *NullableDnsZoneRecordResponse) Set(val *DnsZoneRecordResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneRecordResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneRecordResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneRecordResponse(val *DnsZoneRecordResponse) *NullableDnsZoneRecordResponse {
	return &NullableDnsZoneRecordResponse{value: val, isSet: true}
}

func (v NullableDnsZoneRecordResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneRecordResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
