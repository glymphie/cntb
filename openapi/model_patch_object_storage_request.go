...
// PatchObjectStorageRequest struct for PatchObjectStorageRequest
...
func NewPatchObjectStorageRequest(displayName string) *PatchObjectStorageRequest {
	this := PatchObjectStorageRequest{}
...
func (o PatchObjectStorageRequest) MarshalJSON() ([]byte, error) {
...
type NullablePatchObjectStorageRequest struct {
	value *PatchObjectStorageRequest
	isSet bool
}

func (v NullablePatchObjectStorageRequest) Get() *PatchObjectStorageRequest {
	return v.value
}

func (v *NullablePatchObjectStorageRequest) Set(val *PatchObjectStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchObjectStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchObjectStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchObjectStorageRequest(val *PatchObjectStorageRequest) *NullablePatchObjectStorageRequest {
	return &NullablePatchObjectStorageRequest{value: val, isSet: true}
}

func (v NullablePatchObjectStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchObjectStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
