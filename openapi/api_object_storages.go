...
func (r ApiCancelObjectStorageRequest) CancelObjectStorageRequest(cancelObjectStorageRequest CancelObjectStorageRequest) ApiCancelObjectStorageRequest {
	r.cancelObjectStorageRequest = &cancelObjectStorageRequest
	return r
}
...
func (a *ObjectStoragesApiService) CancelObjectStorageExecute(r ApiCancelObjectStorageRequest) (CancelObjectStorageResponse, *_nethttp.Response, error) {
	...
	if r.cancelObjectStorageRequest == nil {
		return localVarReturnValue, nil, reportError("cancelObjectStorageRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.cancelObjectStorageRequest
