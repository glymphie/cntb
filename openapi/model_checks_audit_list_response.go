...
// ChecksAuditListResponse struct for ChecksAuditListResponse
type ChecksAuditListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []ChecksAuditResponse `json:"data"`
...
func (o ChecksAuditListResponse) MarshalJSON() ([]byte, error) {
...
type NullableChecksAuditListResponse struct {
	value *ChecksAuditListResponse
	isSet bool
}

func (v NullableChecksAuditListResponse) Get() *ChecksAuditListResponse {
	return v.value
}

func (v *NullableChecksAuditListResponse) Set(val *ChecksAuditListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksAuditListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksAuditListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksAuditListResponse(val *ChecksAuditListResponse) *NullableChecksAuditListResponse {
	return &NullableChecksAuditListResponse{value: val, isSet: true}
}

func (v NullableChecksAuditListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChecksAuditListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
