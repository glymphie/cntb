...
// DnsZoneResponse struct for DnsZoneResponse
...
func (o DnsZoneResponse) MarshalJSON() ([]byte, error) {
...
type NullableDnsZoneResponse struct {
	value *DnsZoneResponse
	isSet bool
}

func (v NullableDnsZoneResponse) Get() *DnsZoneResponse {
	return v.value
}

func (v *NullableDnsZoneResponse) Set(val *DnsZoneResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneResponse(val *DnsZoneResponse) *NullableDnsZoneResponse {
	return &NullableDnsZoneResponse{value: val, isSet: true}
}

func (v NullableDnsZoneResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
