...
// FindPrivateNetworkResponse struct for FindPrivateNetworkResponse
...
func NewFindPrivateNetworkResponse(data []PrivateNetworkResponse, links SelfLinks) *FindPrivateNetworkResponse {
	this := FindPrivateNetworkResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o FindPrivateNetworkResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindPrivateNetworkResponse struct {
	value *FindPrivateNetworkResponse
	isSet bool
}

func (v NullableFindPrivateNetworkResponse) Get() *FindPrivateNetworkResponse {
	return v.value
}

func (v *NullableFindPrivateNetworkResponse) Set(val *FindPrivateNetworkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindPrivateNetworkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindPrivateNetworkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindPrivateNetworkResponse(val *FindPrivateNetworkResponse) *NullableFindPrivateNetworkResponse {
	return &NullableFindPrivateNetworkResponse{value: val, isSet: true}
}

func (v NullableFindPrivateNetworkResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindPrivateNetworkResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
