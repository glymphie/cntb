...
// FindRoleResponse struct for FindRoleResponse
...
func (o FindRoleResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindRoleResponse struct {
	value *FindRoleResponse
	isSet bool
}

func (v NullableFindRoleResponse) Get() *FindRoleResponse {
	return v.value
}

func (v *NullableFindRoleResponse) Set(val *FindRoleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindRoleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindRoleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindRoleResponse(val *FindRoleResponse) *NullableFindRoleResponse {
	return &NullableFindRoleResponse{value: val, isSet: true}
}

func (v NullableFindRoleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindRoleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
