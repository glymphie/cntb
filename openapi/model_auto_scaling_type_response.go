...
// AutoScalingTypeResponse struct for AutoScalingTypeResponse
...
func NewAutoScalingTypeResponse(state string, sizeLimitTB float64) *AutoScalingTypeResponse {
	this := AutoScalingTypeResponse{}
	this.State = state
	this.SizeLimitTB = sizeLimitTB
	return &this
}
...
// GetSizeLimitTB returns the SizeLimitTB field value
...
// GetSizeLimitTBOk returns a tuple with the SizeLimitTB field value
// and a boolean to check if the value has been set.
...
// SetSizeLimitTB sets field value
...
func (o AutoScalingTypeResponse) MarshalJSON() ([]byte, error) {
...
type NullableAutoScalingTypeResponse struct {
	value *AutoScalingTypeResponse
	isSet bool
}

func (v NullableAutoScalingTypeResponse) Get() *AutoScalingTypeResponse {
	return v.value
}

func (v *NullableAutoScalingTypeResponse) Set(val *AutoScalingTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoScalingTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoScalingTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoScalingTypeResponse(val *AutoScalingTypeResponse) *NullableAutoScalingTypeResponse {
	return &NullableAutoScalingTypeResponse{value: val, isSet: true}
}

func (v NullableAutoScalingTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoScalingTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
