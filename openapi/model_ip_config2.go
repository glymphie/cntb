...
// IpConfig2 struct for IpConfig2
type IpConfig2 struct {
	V4 IpV43 `json:"v4"`
	V6 IpV6 `json:"v6"`
}
...
func (o IpConfig2) MarshalJSON() ([]byte, error) {
...
type NullableIpConfig2 struct {
	value *IpConfig2
	isSet bool
}

func (v NullableIpConfig2) Get() *IpConfig2 {
	return v.value
}

func (v *NullableIpConfig2) Set(val *IpConfig2) {
	v.value = val
	v.isSet = true
}

func (v NullableIpConfig2) IsSet() bool {
	return v.isSet
}

func (v *NullableIpConfig2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpConfig2(val *IpConfig2) *NullableIpConfig2 {
	return &NullableIpConfig2{value: val, isSet: true}
}

func (v NullableIpConfig2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpConfig2) UnmarshalJSON(src []byte) error {
	v.isSet = true
