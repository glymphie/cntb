...
// FindUserResponse struct for FindUserResponse
...
func (o FindUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindUserResponse struct {
	value *FindUserResponse
	isSet bool
}

func (v NullableFindUserResponse) Get() *FindUserResponse {
	return v.value
}

func (v *NullableFindUserResponse) Set(val *FindUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindUserResponse(val *FindUserResponse) *NullableFindUserResponse {
	return &NullableFindUserResponse{value: val, isSet: true}
}

func (v NullableFindUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
