...
// AuditCountResponse struct for AuditCountResponse
...
func (o AuditCountResponse) MarshalJSON() ([]byte, error) {
...
type NullableAuditCountResponse struct {
	value *AuditCountResponse
	isSet bool
}

func (v NullableAuditCountResponse) Get() *AuditCountResponse {
	return v.value
}

func (v *NullableAuditCountResponse) Set(val *AuditCountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditCountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditCountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditCountResponse(val *AuditCountResponse) *NullableAuditCountResponse {
	return &NullableAuditCountResponse{value: val, isSet: true}
}

func (v NullableAuditCountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditCountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
