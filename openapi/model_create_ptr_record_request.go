...
// CreatePtrRecordRequest struct for CreatePtrRecordRequest
type CreatePtrRecordRequest struct {
	// PTR Record name
	Ptr string `json:"ptr"`
	// IP Address
	Ip string `json:"ip"`
...
func (o CreatePtrRecordRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreatePtrRecordRequest struct {
	value *CreatePtrRecordRequest
	isSet bool
}

func (v NullableCreatePtrRecordRequest) Get() *CreatePtrRecordRequest {
	return v.value
}

func (v *NullableCreatePtrRecordRequest) Set(val *CreatePtrRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePtrRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePtrRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePtrRecordRequest(val *CreatePtrRecordRequest) *NullableCreatePtrRecordRequest {
	return &NullableCreatePtrRecordRequest{value: val, isSet: true}
}

func (v NullableCreatePtrRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePtrRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
