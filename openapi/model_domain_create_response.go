...
// DomainCreateResponse struct for DomainCreateResponse
...
func (o DomainCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainCreateResponse struct {
	value *DomainCreateResponse
	isSet bool
}

func (v NullableDomainCreateResponse) Get() *DomainCreateResponse {
	return v.value
}

func (v *NullableDomainCreateResponse) Set(val *DomainCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainCreateResponse(val *DomainCreateResponse) *NullableDomainCreateResponse {
	return &NullableDomainCreateResponse{value: val, isSet: true}
}

func (v NullableDomainCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
