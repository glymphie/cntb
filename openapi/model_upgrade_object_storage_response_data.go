...
// UpgradeObjectStorageResponseData struct for UpgradeObjectStorageResponseData
...
func NewUpgradeObjectStorageResponseData(tenantId string, customerId string, objectStorageId string, createdDate string, dataCenter string, autoScaling AutoScalingTypeResponse, s3Url string, status string, totalPurchasedSpaceTB float64, region string, displayName string) *UpgradeObjectStorageResponseData {
	this := UpgradeObjectStorageResponseData{}
...
func (o UpgradeObjectStorageResponseData) MarshalJSON() ([]byte, error) {
...
type NullableUpgradeObjectStorageResponseData struct {
	value *UpgradeObjectStorageResponseData
	isSet bool
}

func (v NullableUpgradeObjectStorageResponseData) Get() *UpgradeObjectStorageResponseData {
	return v.value
}

func (v *NullableUpgradeObjectStorageResponseData) Set(val *UpgradeObjectStorageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeObjectStorageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeObjectStorageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeObjectStorageResponseData(val *UpgradeObjectStorageResponseData) *NullableUpgradeObjectStorageResponseData {
	return &NullableUpgradeObjectStorageResponseData{value: val, isSet: true}
}

func (v NullableUpgradeObjectStorageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeObjectStorageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
