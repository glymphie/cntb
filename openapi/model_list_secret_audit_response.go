...
// ListSecretAuditResponse struct for ListSecretAuditResponse
...
func (o ListSecretAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSecretAuditResponse struct {
	value *ListSecretAuditResponse
	isSet bool
}

func (v NullableListSecretAuditResponse) Get() *ListSecretAuditResponse {
	return v.value
}

func (v *NullableListSecretAuditResponse) Set(val *ListSecretAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSecretAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSecretAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSecretAuditResponse(val *ListSecretAuditResponse) *NullableListSecretAuditResponse {
	return &NullableListSecretAuditResponse{value: val, isSet: true}
}

func (v NullableListSecretAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSecretAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
