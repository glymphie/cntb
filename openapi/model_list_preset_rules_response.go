...
// ListPresetRulesResponse struct for ListPresetRulesResponse
type ListPresetRulesResponse struct {
	Data []PresetRulesResponse `json:"data"`
...
func (o ListPresetRulesResponse) MarshalJSON() ([]byte, error) {
...
type NullableListPresetRulesResponse struct {
	value *ListPresetRulesResponse
	isSet bool
}

func (v NullableListPresetRulesResponse) Get() *ListPresetRulesResponse {
	return v.value
}

func (v *NullableListPresetRulesResponse) Set(val *ListPresetRulesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListPresetRulesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListPresetRulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPresetRulesResponse(val *ListPresetRulesResponse) *NullableListPresetRulesResponse {
	return &NullableListPresetRulesResponse{value: val, isSet: true}
}

func (v NullableListPresetRulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPresetRulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
