...
// InstanceAssignmentSelfLinks struct for InstanceAssignmentSelfLinks
...
func NewInstanceAssignmentSelfLinks(self string, virtualPrivateCloud string, instance string) *InstanceAssignmentSelfLinks {
	this := InstanceAssignmentSelfLinks{}
	this.Self = self
...
func (o InstanceAssignmentSelfLinks) MarshalJSON() ([]byte, error) {
...
type NullableInstanceAssignmentSelfLinks struct {
	value *InstanceAssignmentSelfLinks
	isSet bool
}

func (v NullableInstanceAssignmentSelfLinks) Get() *InstanceAssignmentSelfLinks {
	return v.value
}

func (v *NullableInstanceAssignmentSelfLinks) Set(val *InstanceAssignmentSelfLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceAssignmentSelfLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceAssignmentSelfLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceAssignmentSelfLinks(val *InstanceAssignmentSelfLinks) *NullableInstanceAssignmentSelfLinks {
	return &NullableInstanceAssignmentSelfLinks{value: val, isSet: true}
}

func (v NullableInstanceAssignmentSelfLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceAssignmentSelfLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
