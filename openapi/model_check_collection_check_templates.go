...
// CheckCollectionCheckTemplates struct for CheckCollectionCheckTemplates
type CheckCollectionCheckTemplates struct {
	// Id of the check
	...
	CheckTemplates *[]CheckCollectionCheckTemplates `json:"checkTemplates,omitempty"`
}
...
func NewCheckCollectionCheckTemplates(checkId float32, checkTemplateId float32, runConcurrent bool, ignoreErrors bool) *CheckCollectionCheckTemplates {
	this := CheckCollectionCheckTemplates{}
...
// SetCheckTemplates gets a reference to the given []CheckCollectionCheckTemplates and assigns it to the CheckTemplates field.
func (o *CheckCollectionCheckTemplates) SetCheckTemplates(v []CheckCollectionCheckTemplates) {
	o.CheckTemplates = &v
}

func (o CheckCollectionCheckTemplates) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionCheckTemplates struct {
	value *CheckCollectionCheckTemplates
	isSet bool
}

func (v NullableCheckCollectionCheckTemplates) Get() *CheckCollectionCheckTemplates {
	return v.value
}

func (v *NullableCheckCollectionCheckTemplates) Set(val *CheckCollectionCheckTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionCheckTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionCheckTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionCheckTemplates(val *CheckCollectionCheckTemplates) *NullableCheckCollectionCheckTemplates {
	return &NullableCheckCollectionCheckTemplates{value: val, isSet: true}
}

func (v NullableCheckCollectionCheckTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionCheckTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
