...
// BulkDeleteResultResponse struct for BulkDeleteResultResponse
type BulkDeleteResultResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// Failed zone record IDs
...
func (o BulkDeleteResultResponse) MarshalJSON() ([]byte, error) {
...
type NullableBulkDeleteResultResponse struct {
	value *BulkDeleteResultResponse
	isSet bool
}

func (v NullableBulkDeleteResultResponse) Get() *BulkDeleteResultResponse {
	return v.value
}

func (v *NullableBulkDeleteResultResponse) Set(val *BulkDeleteResultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkDeleteResultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkDeleteResultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkDeleteResultResponse(val *BulkDeleteResultResponse) *NullableBulkDeleteResultResponse {
	return &NullableBulkDeleteResultResponse{value: val, isSet: true}
}

func (v NullableBulkDeleteResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkDeleteResultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
