...
func (o AssignInstanceFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableAssignInstanceFirewallResponse struct {
	value *AssignInstanceFirewallResponse
	isSet bool
}

func (v NullableAssignInstanceFirewallResponse) Get() *AssignInstanceFirewallResponse {
	return v.value
}

func (v *NullableAssignInstanceFirewallResponse) Set(val *AssignInstanceFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignInstanceFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignInstanceFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignInstanceFirewallResponse(val *AssignInstanceFirewallResponse) *NullableAssignInstanceFirewallResponse {
	return &NullableAssignInstanceFirewallResponse{value: val, isSet: true}
}

func (v NullableAssignInstanceFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignInstanceFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
