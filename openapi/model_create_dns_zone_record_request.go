...
// CreateDnsZoneRecordRequest struct for CreateDnsZoneRecordRequest
...
func NewCreateDnsZoneRecordRequest(type_ string, ttl float32, prio float32, data string) *CreateDnsZoneRecordRequest {
	this := CreateDnsZoneRecordRequest{}
	this.Type = type_
	this.Ttl = ttl
	this.Prio = prio
	this.Data = data
...
// SetFlag gets a reference to the given float32 and assigns it to the Flag field.
...
func (o CreateDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreateDnsZoneRecordRequest struct {
	value *CreateDnsZoneRecordRequest
	isSet bool
}

func (v NullableCreateDnsZoneRecordRequest) Get() *CreateDnsZoneRecordRequest {
	return v.value
}

func (v *NullableCreateDnsZoneRecordRequest) Set(val *CreateDnsZoneRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDnsZoneRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDnsZoneRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDnsZoneRecordRequest(val *CreateDnsZoneRecordRequest) *NullableCreateDnsZoneRecordRequest {
	return &NullableCreateDnsZoneRecordRequest{value: val, isSet: true}
}

func (v NullableCreateDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDnsZoneRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
