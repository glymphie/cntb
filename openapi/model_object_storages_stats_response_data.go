...
// ObjectStoragesStatsResponseData struct for ObjectStoragesStatsResponseData
...
func NewObjectStoragesStatsResponseData(tenantId string, customerId string, usedSpaceTB float64, usedSpacePercentage float64, numberOfObjects int64) *ObjectStoragesStatsResponseData {
	this := ObjectStoragesStatsResponseData{}
...
// GetNumberOfObjects returns the NumberOfObjects field value
func (o *ObjectStoragesStatsResponseData) GetNumberOfObjects() int64 {
	...
	return o.NumberOfObjects
}

// GetNumberOfObjectsOk returns a tuple with the NumberOfObjects field value
// and a boolean to check if the value has been set.
func (o *ObjectStoragesStatsResponseData) GetNumberOfObjectsOk() (*int64, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.NumberOfObjects, true
}

// SetNumberOfObjects sets field value
func (o *ObjectStoragesStatsResponseData) SetNumberOfObjects(v int64) {
	o.NumberOfObjects = v
}

func (o ObjectStoragesStatsResponseData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["numberOfObjects"] = o.NumberOfObjects
	}
	return json.Marshal(toSerialize)
}

type NullableObjectStoragesStatsResponseData struct {
	value *ObjectStoragesStatsResponseData
	isSet bool
}

func (v NullableObjectStoragesStatsResponseData) Get() *ObjectStoragesStatsResponseData {
	return v.value
}

func (v *NullableObjectStoragesStatsResponseData) Set(val *ObjectStoragesStatsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStoragesStatsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStoragesStatsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStoragesStatsResponseData(val *ObjectStoragesStatsResponseData) *NullableObjectStoragesStatsResponseData {
	return &NullableObjectStoragesStatsResponseData{value: val, isSet: true}
}

func (v NullableObjectStoragesStatsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStoragesStatsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
