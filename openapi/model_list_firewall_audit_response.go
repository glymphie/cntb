...
// ListFirewallAuditResponse struct for ListFirewallAuditResponse
type ListFirewallAuditResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []FirewallAuditResponse `json:"data"`
...
func NewListFirewallAuditResponse(pagination PaginationMeta, data []FirewallAuditResponse, links Links) *ListFirewallAuditResponse {
	this := ListFirewallAuditResponse{}
...
func (o ListFirewallAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListFirewallAuditResponse struct {
	value *ListFirewallAuditResponse
	isSet bool
}

func (v NullableListFirewallAuditResponse) Get() *ListFirewallAuditResponse {
	return v.value
}

func (v *NullableListFirewallAuditResponse) Set(val *ListFirewallAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListFirewallAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListFirewallAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFirewallAuditResponse(val *ListFirewallAuditResponse) *NullableListFirewallAuditResponse {
	return &NullableListFirewallAuditResponse{value: val, isSet: true}
}

func (v NullableListFirewallAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFirewallAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
