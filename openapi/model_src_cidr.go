...
// SrcCidr struct for SrcCidr
type SrcCidr struct {
	// IPv4 addresses in CIDR notation or \"AnyIPv4\" to allow all IPv4 sources (translates to 0.0.0.0/0)
	Ipv4 *[]string `json:"ipv4,omitempty"`
	// IPv6 addresses in CIDR notation or \"AnyIPv6\" to allow all IPv6 sources (translates to ::/0)
...
func (o SrcCidr) MarshalJSON() ([]byte, error) {
...
type NullableSrcCidr struct {
	value *SrcCidr
	isSet bool
}

func (v NullableSrcCidr) Get() *SrcCidr {
	return v.value
}

func (v *NullableSrcCidr) Set(val *SrcCidr) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcCidr) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcCidr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcCidr(val *SrcCidr) *NullableSrcCidr {
	return &NullableSrcCidr{value: val, isSet: true}
}

func (v NullableSrcCidr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcCidr) UnmarshalJSON(src []byte) error {
	v.isSet = true
