...
// FindAssignmentResponse struct for FindAssignmentResponse
...
func (o FindAssignmentResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindAssignmentResponse struct {
	value *FindAssignmentResponse
	isSet bool
}

func (v NullableFindAssignmentResponse) Get() *FindAssignmentResponse {
	return v.value
}

func (v *NullableFindAssignmentResponse) Set(val *FindAssignmentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindAssignmentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindAssignmentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindAssignmentResponse(val *FindAssignmentResponse) *NullableFindAssignmentResponse {
	return &NullableFindAssignmentResponse{value: val, isSet: true}
}

func (v NullableFindAssignmentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindAssignmentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
