...
// ObjectStoragesStatsResponse struct for ObjectStoragesStatsResponse
...
func NewObjectStoragesStatsResponse(data []ObjectStoragesStatsResponseData, links SelfLinks) *ObjectStoragesStatsResponse {
	this := ObjectStoragesStatsResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *ObjectStoragesStatsResponse) GetData() []ObjectStoragesStatsResponseData {
	if o == nil {
		var ret []ObjectStoragesStatsResponseData
		return ret
	}
...
func (o ObjectStoragesStatsResponse) MarshalJSON() ([]byte, error) {
...
type NullableObjectStoragesStatsResponse struct {
	value *ObjectStoragesStatsResponse
	isSet bool
}

func (v NullableObjectStoragesStatsResponse) Get() *ObjectStoragesStatsResponse {
	return v.value
}

func (v *NullableObjectStoragesStatsResponse) Set(val *ObjectStoragesStatsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStoragesStatsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStoragesStatsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStoragesStatsResponse(val *ObjectStoragesStatsResponse) *NullableObjectStoragesStatsResponse {
	return &NullableObjectStoragesStatsResponse{value: val, isSet: true}
}

func (v NullableObjectStoragesStatsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStoragesStatsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
