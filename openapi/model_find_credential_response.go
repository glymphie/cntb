...
// FindCredentialResponse struct for FindCredentialResponse
...
func (o FindCredentialResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindCredentialResponse struct {
	value *FindCredentialResponse
	isSet bool
}

func (v NullableFindCredentialResponse) Get() *FindCredentialResponse {
	return v.value
}

func (v *NullableFindCredentialResponse) Set(val *FindCredentialResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindCredentialResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindCredentialResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindCredentialResponse(val *FindCredentialResponse) *NullableFindCredentialResponse {
	return &NullableFindCredentialResponse{value: val, isSet: true}
}

func (v NullableFindCredentialResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindCredentialResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
