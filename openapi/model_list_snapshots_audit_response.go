...
// ListSnapshotsAuditResponse struct for ListSnapshotsAuditResponse
...
func NewListSnapshotsAuditResponse(pagination PaginationMeta, data []SnapshotsAuditResponse, links Links) *ListSnapshotsAuditResponse {
	this := ListSnapshotsAuditResponse{}
...
func (o *ListSnapshotsAuditResponse) GetData() []SnapshotsAuditResponse {
	if o == nil {
		var ret []SnapshotsAuditResponse
		return ret
	}
...
func (o ListSnapshotsAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSnapshotsAuditResponse struct {
	value *ListSnapshotsAuditResponse
	isSet bool
}

func (v NullableListSnapshotsAuditResponse) Get() *ListSnapshotsAuditResponse {
	return v.value
}

func (v *NullableListSnapshotsAuditResponse) Set(val *ListSnapshotsAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSnapshotsAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSnapshotsAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSnapshotsAuditResponse(val *ListSnapshotsAuditResponse) *NullableListSnapshotsAuditResponse {
	return &NullableListSnapshotsAuditResponse{value: val, isSet: true}
}

func (v NullableListSnapshotsAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSnapshotsAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
