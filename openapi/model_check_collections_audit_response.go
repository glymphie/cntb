...
// CheckCollectionsAuditResponse struct for CheckCollectionsAuditResponse
type CheckCollectionsAuditResponse struct {
	// Creation date
...
func NewCheckCollectionsAuditResponse(createdDate time.Time, modifiedDate time.Time, orgId string, accountId string, auditId int64, action string, foreignChangedBy string, foreignUsername string, changedBy string, username string, requestId string, traceId string, changes Changes, checkCollectionId float32) *CheckCollectionsAuditResponse {
	this := CheckCollectionsAuditResponse{}
...
func (o CheckCollectionsAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableCheckCollectionsAuditResponse struct {
	value *CheckCollectionsAuditResponse
	isSet bool
}

func (v NullableCheckCollectionsAuditResponse) Get() *CheckCollectionsAuditResponse {
	return v.value
}

func (v *NullableCheckCollectionsAuditResponse) Set(val *CheckCollectionsAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCollectionsAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCollectionsAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCollectionsAuditResponse(val *CheckCollectionsAuditResponse) *NullableCheckCollectionsAuditResponse {
	return &NullableCheckCollectionsAuditResponse{value: val, isSet: true}
}

func (v NullableCheckCollectionsAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckCollectionsAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
