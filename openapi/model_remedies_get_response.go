...
// RemediesGetResponse struct for RemediesGetResponse
type RemediesGetResponse struct {
...
func (o RemediesGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableRemediesGetResponse struct {
	value *RemediesGetResponse
	isSet bool
}

func (v NullableRemediesGetResponse) Get() *RemediesGetResponse {
	return v.value
}

func (v *NullableRemediesGetResponse) Set(val *RemediesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemediesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemediesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemediesGetResponse(val *RemediesGetResponse) *NullableRemediesGetResponse {
	return &NullableRemediesGetResponse{value: val, isSet: true}
}

func (v NullableRemediesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemediesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
