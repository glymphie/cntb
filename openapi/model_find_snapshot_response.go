...
// FindSnapshotResponse struct for FindSnapshotResponse
...
func (o FindSnapshotResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindSnapshotResponse struct {
	value *FindSnapshotResponse
	isSet bool
}

func (v NullableFindSnapshotResponse) Get() *FindSnapshotResponse {
	return v.value
}

func (v *NullableFindSnapshotResponse) Set(val *FindSnapshotResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindSnapshotResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindSnapshotResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindSnapshotResponse(val *FindSnapshotResponse) *NullableFindSnapshotResponse {
	return &NullableFindSnapshotResponse{value: val, isSet: true}
}

func (v NullableFindSnapshotResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindSnapshotResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
