...
// InstanceStartActionResponse struct for InstanceStartActionResponse
...
func NewInstanceStartActionResponse(data []InstanceStartActionResponseData, links SelfLinks) *InstanceStartActionResponse {
	this := InstanceStartActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceStartActionResponse) GetData() []InstanceStartActionResponseData {
	if o == nil {
		var ret []InstanceStartActionResponseData
		return ret
	}
...
func (o InstanceStartActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceStartActionResponse struct {
	value *InstanceStartActionResponse
	isSet bool
}

func (v NullableInstanceStartActionResponse) Get() *InstanceStartActionResponse {
	return v.value
}

func (v *NullableInstanceStartActionResponse) Set(val *InstanceStartActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceStartActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceStartActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceStartActionResponse(val *InstanceStartActionResponse) *NullableInstanceStartActionResponse {
	return &NullableInstanceStartActionResponse{value: val, isSet: true}
}

func (v NullableInstanceStartActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceStartActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
