...
type CreateFirewallRequest struct {
	...
	// The status of the firewall determines whether the rules are active or not.
...
// SetRules gets a reference to the given RulesRequest and assigns it to the Rules field.
