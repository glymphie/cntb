...
// FirewallAuditResponse struct for FirewallAuditResponse
...
func (o FirewallAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableFirewallAuditResponse struct {
	value *FirewallAuditResponse
	isSet bool
}

func (v NullableFirewallAuditResponse) Get() *FirewallAuditResponse {
	return v.value
}

func (v *NullableFirewallAuditResponse) Set(val *FirewallAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallAuditResponse(val *FirewallAuditResponse) *NullableFirewallAuditResponse {
	return &NullableFirewallAuditResponse{value: val, isSet: true}
}

func (v NullableFirewallAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
