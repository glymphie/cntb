...
// DomainPatchResponse struct for DomainPatchResponse
...
func (o DomainPatchResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainPatchResponse struct {
	value *DomainPatchResponse
	isSet bool
}

func (v NullableDomainPatchResponse) Get() *DomainPatchResponse {
	return v.value
}

func (v *NullableDomainPatchResponse) Set(val *DomainPatchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainPatchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainPatchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainPatchResponse(val *DomainPatchResponse) *NullableDomainPatchResponse {
	return &NullableDomainPatchResponse{value: val, isSet: true}
}

func (v NullableDomainPatchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainPatchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
