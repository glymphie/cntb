...
func (o UnassignInstanceFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableUnassignInstanceFirewallResponse struct {
	value *UnassignInstanceFirewallResponse
	isSet bool
}

func (v NullableUnassignInstanceFirewallResponse) Get() *UnassignInstanceFirewallResponse {
	return v.value
}

func (v *NullableUnassignInstanceFirewallResponse) Set(val *UnassignInstanceFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnassignInstanceFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnassignInstanceFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnassignInstanceFirewallResponse(val *UnassignInstanceFirewallResponse) *NullableUnassignInstanceFirewallResponse {
	return &NullableUnassignInstanceFirewallResponse{value: val, isSet: true}
}

func (v NullableUnassignInstanceFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnassignInstanceFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
