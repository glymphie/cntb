...
// InstanceAssignmentSelfLinks1 struct for InstanceAssignmentSelfLinks1
...
func (o InstanceAssignmentSelfLinks1) MarshalJSON() ([]byte, error) {
...
type NullableInstanceAssignmentSelfLinks1 struct {
	value *InstanceAssignmentSelfLinks1
	isSet bool
}

func (v NullableInstanceAssignmentSelfLinks1) Get() *InstanceAssignmentSelfLinks1 {
	return v.value
}

func (v *NullableInstanceAssignmentSelfLinks1) Set(val *InstanceAssignmentSelfLinks1) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceAssignmentSelfLinks1) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceAssignmentSelfLinks1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceAssignmentSelfLinks1(val *InstanceAssignmentSelfLinks1) *NullableInstanceAssignmentSelfLinks1 {
	return &NullableInstanceAssignmentSelfLinks1{value: val, isSet: true}
}

func (v NullableInstanceAssignmentSelfLinks1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceAssignmentSelfLinks1) UnmarshalJSON(src []byte) error {
	v.isSet = true
