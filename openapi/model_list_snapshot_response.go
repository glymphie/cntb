...
// ListSnapshotResponse struct for ListSnapshotResponse
...
func (o ListSnapshotResponse) MarshalJSON() ([]byte, error) {
...
type NullableListSnapshotResponse struct {
	value *ListSnapshotResponse
	isSet bool
}

func (v NullableListSnapshotResponse) Get() *ListSnapshotResponse {
	return v.value
}

func (v *NullableListSnapshotResponse) Set(val *ListSnapshotResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSnapshotResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSnapshotResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSnapshotResponse(val *ListSnapshotResponse) *NullableListSnapshotResponse {
	return &NullableListSnapshotResponse{value: val, isSet: true}
}

func (v NullableListSnapshotResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSnapshotResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
