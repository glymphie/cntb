...
// RemediesCreateRequest struct for RemediesCreateRequest
type RemediesCreateRequest struct {
	...
	// Remedy Collection for this remedy
	RemedyCollectionId *float32 `json:"remedyCollectionId,omitempty"`
...
// GetRemedyCollectionId returns the RemedyCollectionId field value if set, zero value otherwise.
func (o *RemediesCreateRequest) GetRemedyCollectionId() float32 {
	if o == nil || o.RemedyCollectionId == nil {
		var ret float32
		return ret
	}
...
// GetRemedyCollectionIdOk returns a tuple with the RemedyCollectionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRemedyCollectionId gets a reference to the given float32 and assigns it to the RemedyCollectionId field.
...
func (o RemediesCreateRequest) MarshalJSON() ([]byte, error) {
...
type NullableRemediesCreateRequest struct {
	value *RemediesCreateRequest
	isSet bool
}

func (v NullableRemediesCreateRequest) Get() *RemediesCreateRequest {
	return v.value
}

func (v *NullableRemediesCreateRequest) Set(val *RemediesCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRemediesCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRemediesCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemediesCreateRequest(val *RemediesCreateRequest) *NullableRemediesCreateRequest {
	return &NullableRemediesCreateRequest{value: val, isSet: true}
}

func (v NullableRemediesCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemediesCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
