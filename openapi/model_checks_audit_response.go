...
// ChecksAuditResponse struct for ChecksAuditResponse
type ChecksAuditResponse struct {
	// Creation date
...
func (o ChecksAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableChecksAuditResponse struct {
	value *ChecksAuditResponse
	isSet bool
}

func (v NullableChecksAuditResponse) Get() *ChecksAuditResponse {
	return v.value
}

func (v *NullableChecksAuditResponse) Set(val *ChecksAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksAuditResponse(val *ChecksAuditResponse) *NullableChecksAuditResponse {
	return &NullableChecksAuditResponse{value: val, isSet: true}
}

func (v NullableChecksAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChecksAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
