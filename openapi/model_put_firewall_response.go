...
// PutFirewallResponse struct for PutFirewallResponse
type PutFirewallResponse struct {
...
func (o PutFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullablePutFirewallResponse struct {
	value *PutFirewallResponse
	isSet bool
}

func (v NullablePutFirewallResponse) Get() *PutFirewallResponse {
	return v.value
}

func (v *NullablePutFirewallResponse) Set(val *PutFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePutFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePutFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutFirewallResponse(val *PutFirewallResponse) *NullablePutFirewallResponse {
	return &NullablePutFirewallResponse{value: val, isSet: true}
}

func (v NullablePutFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
