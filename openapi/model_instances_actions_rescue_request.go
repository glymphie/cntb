...
// InstancesActionsRescueRequest struct for InstancesActionsRescueRequest
...
func NewInstancesActionsRescueRequest() *InstancesActionsRescueRequest {
	this := InstancesActionsRescueRequest{}
	return &this
}
...
func (o InstancesActionsRescueRequest) MarshalJSON() ([]byte, error) {
...
type NullableInstancesActionsRescueRequest struct {
	value *InstancesActionsRescueRequest
	isSet bool
}

func (v NullableInstancesActionsRescueRequest) Get() *InstancesActionsRescueRequest {
	return v.value
}

func (v *NullableInstancesActionsRescueRequest) Set(val *InstancesActionsRescueRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesActionsRescueRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesActionsRescueRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesActionsRescueRequest(val *InstancesActionsRescueRequest) *NullableInstancesActionsRescueRequest {
	return &NullableInstancesActionsRescueRequest{value: val, isSet: true}
}

func (v NullableInstancesActionsRescueRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesActionsRescueRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
