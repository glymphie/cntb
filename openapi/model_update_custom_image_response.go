...
// UpdateCustomImageResponse struct for UpdateCustomImageResponse
...
func NewUpdateCustomImageResponse(data []UpdateCustomImageResponseData, links SelfLinks) *UpdateCustomImageResponse {
	this := UpdateCustomImageResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *UpdateCustomImageResponse) GetData() []UpdateCustomImageResponseData {
	if o == nil {
		var ret []UpdateCustomImageResponseData
		return ret
	}
...
func (o UpdateCustomImageResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateCustomImageResponse struct {
	value *UpdateCustomImageResponse
	isSet bool
}

func (v NullableUpdateCustomImageResponse) Get() *UpdateCustomImageResponse {
	return v.value
}

func (v *NullableUpdateCustomImageResponse) Set(val *UpdateCustomImageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCustomImageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCustomImageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCustomImageResponse(val *UpdateCustomImageResponse) *NullableUpdateCustomImageResponse {
	return &NullableUpdateCustomImageResponse{value: val, isSet: true}
}

func (v NullableUpdateCustomImageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCustomImageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
