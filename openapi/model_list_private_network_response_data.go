...
// ListPrivateNetworkResponseData struct for ListPrivateNetworkResponseData
...
func NewListPrivateNetworkResponseData(tenantId string, customerId string, privateNetworkId int64, dataCenter string, region string, regionName string, name string, description string, cidr string, availableIps int64, createdDate time.Time, instances []Instances) *ListPrivateNetworkResponseData {
	this := ListPrivateNetworkResponseData{}
...
func (o ListPrivateNetworkResponseData) MarshalJSON() ([]byte, error) {
...
type NullableListPrivateNetworkResponseData struct {
	value *ListPrivateNetworkResponseData
	isSet bool
}

func (v NullableListPrivateNetworkResponseData) Get() *ListPrivateNetworkResponseData {
	return v.value
}

func (v *NullableListPrivateNetworkResponseData) Set(val *ListPrivateNetworkResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableListPrivateNetworkResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableListPrivateNetworkResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPrivateNetworkResponseData(val *ListPrivateNetworkResponseData) *NullableListPrivateNetworkResponseData {
	return &NullableListPrivateNetworkResponseData{value: val, isSet: true}
}

func (v NullableListPrivateNetworkResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPrivateNetworkResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
