...
// FindFirewallResponse struct for FindFirewallResponse
type FindFirewallResponse struct {
...
func (o FindFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindFirewallResponse struct {
	value *FindFirewallResponse
	isSet bool
}

func (v NullableFindFirewallResponse) Get() *FindFirewallResponse {
	return v.value
}

func (v *NullableFindFirewallResponse) Set(val *FindFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindFirewallResponse(val *FindFirewallResponse) *NullableFindFirewallResponse {
	return &NullableFindFirewallResponse{value: val, isSet: true}
}

func (v NullableFindFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
