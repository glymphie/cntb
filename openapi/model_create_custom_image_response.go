...
// CreateCustomImageResponse struct for CreateCustomImageResponse
...
func NewCreateCustomImageResponse(data []CreateCustomImageResponseData, links SelfLinks) *CreateCustomImageResponse {
	this := CreateCustomImageResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CreateCustomImageResponse) GetData() []CreateCustomImageResponseData {
	if o == nil {
		var ret []CreateCustomImageResponseData
		return ret
	}
...
func (o CreateCustomImageResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateCustomImageResponse struct {
	value *CreateCustomImageResponse
	isSet bool
}

func (v NullableCreateCustomImageResponse) Get() *CreateCustomImageResponse {
	return v.value
}

func (v *NullableCreateCustomImageResponse) Set(val *CreateCustomImageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCustomImageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCustomImageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCustomImageResponse(val *CreateCustomImageResponse) *NullableCreateCustomImageResponse {
	return &NullableCreateCustomImageResponse{value: val, isSet: true}
}

func (v NullableCreateCustomImageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCustomImageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
