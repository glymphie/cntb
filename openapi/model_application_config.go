...
// GetUserDataId returns the UserDataId field value
...
// GetUserDataIdOk returns a tuple with the UserDataId field value
// and a boolean to check if the value has been set.
func (o *ApplicationConfig) GetUserDataIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.UserDataId, true
}

// SetUserDataId sets field value
...
func (o ApplicationConfig) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["userDataId"] = o.UserDataId
	}
	if true {
