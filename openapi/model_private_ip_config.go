...
// PrivateIpConfig struct for PrivateIpConfig
...
func (o PrivateIpConfig) MarshalJSON() ([]byte, error) {
...
type NullablePrivateIpConfig struct {
	value *PrivateIpConfig
	isSet bool
}

func (v NullablePrivateIpConfig) Get() *PrivateIpConfig {
	return v.value
}

func (v *NullablePrivateIpConfig) Set(val *PrivateIpConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateIpConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateIpConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateIpConfig(val *PrivateIpConfig) *NullablePrivateIpConfig {
	return &NullablePrivateIpConfig{value: val, isSet: true}
}

func (v NullablePrivateIpConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateIpConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
