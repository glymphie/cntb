...
// CreateRoleResponseData struct for CreateRoleResponseData
...
func (o CreateRoleResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateRoleResponseData struct {
	value *CreateRoleResponseData
	isSet bool
}

func (v NullableCreateRoleResponseData) Get() *CreateRoleResponseData {
	return v.value
}

func (v *NullableCreateRoleResponseData) Set(val *CreateRoleResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRoleResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRoleResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRoleResponseData(val *CreateRoleResponseData) *NullableCreateRoleResponseData {
	return &NullableCreateRoleResponseData{value: val, isSet: true}
}

func (v NullableCreateRoleResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRoleResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
