...
// DomainCancel struct for DomainCancel
...
func (o DomainCancel) MarshalJSON() ([]byte, error) {
...
type NullableDomainCancel struct {
	value *DomainCancel
	isSet bool
}

func (v NullableDomainCancel) Get() *DomainCancel {
	return v.value
}

func (v *NullableDomainCancel) Set(val *DomainCancel) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainCancel) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainCancel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainCancel(val *DomainCancel) *NullableDomainCancel {
	return &NullableDomainCancel{value: val, isSet: true}
}

func (v NullableDomainCancel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainCancel) UnmarshalJSON(src []byte) error {
	v.isSet = true
