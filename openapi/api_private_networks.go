...
type ApiAssignInstancePrivateNetworkRequest struct {
	...
	ApiService *PrivateNetworksApiService
	xRequestId *string
...
/*
AssignInstancePrivateNetwork Add instance to a Private Network

Add a specific instance to a Private Network

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param privateNetworkId The identifier of the Private Network
 @param instanceId The identifier of the instance
 @return ApiAssignInstancePrivateNetworkRequest
*/
func (a *PrivateNetworksApiService) AssignInstancePrivateNetwork(ctx _context.Context, privateNetworkId int64, instanceId int64) ApiAssignInstancePrivateNetworkRequest {
	return ApiAssignInstancePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *PrivateNetworksApiService) AssignInstancePrivateNetworkExecute(r ApiAssignInstancePrivateNetworkRequest) (AssignInstancePrivateNetworkResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.AssignInstancePrivateNetwork")
	if err != nil {
...
*/
func (a *PrivateNetworksApiService) CreatePrivateNetwork(ctx _context.Context) ApiCreatePrivateNetworkRequest {
	return ApiCreatePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PrivateNetworksApiService) CreatePrivateNetworkExecute(r ApiCreatePrivateNetworkRequest) (CreatePrivateNetworkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.CreatePrivateNetwork")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
DeletePrivateNetwork Delete existing Private Network by id
...
*/
func (a *PrivateNetworksApiService) DeletePrivateNetwork(ctx _context.Context, privateNetworkId int64) ApiDeletePrivateNetworkRequest {
	return ApiDeletePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
		privateNetworkId: privateNetworkId,
...
// Execute executes the request
func (a *PrivateNetworksApiService) DeletePrivateNetworkExecute(r ApiDeletePrivateNetworkRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.DeletePrivateNetwork")
	if err != nil {
...
/*
PatchPrivateNetwork Update a Private Network by id
...
*/
func (a *PrivateNetworksApiService) PatchPrivateNetwork(ctx _context.Context, privateNetworkId int64) ApiPatchPrivateNetworkRequest {
	return ApiPatchPrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
		privateNetworkId: privateNetworkId,
...
func (a *PrivateNetworksApiService) PatchPrivateNetworkExecute(r ApiPatchPrivateNetworkRequest) (PatchPrivateNetworkResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.PatchPrivateNetwork")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
RetrievePrivateNetwork Get specific Private Network by id
...
*/
func (a *PrivateNetworksApiService) RetrievePrivateNetwork(ctx _context.Context, privateNetworkId int64) ApiRetrievePrivateNetworkRequest {
	return ApiRetrievePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
		privateNetworkId: privateNetworkId,
...
func (a *PrivateNetworksApiService) RetrievePrivateNetworkExecute(r ApiRetrievePrivateNetworkRequest) (FindPrivateNetworkResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.RetrievePrivateNetwork")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
RetrievePrivateNetworkList List Private Networks
...
*/
func (a *PrivateNetworksApiService) RetrievePrivateNetworkList(ctx _context.Context) ApiRetrievePrivateNetworkListRequest {
	return ApiRetrievePrivateNetworkListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PrivateNetworksApiService) RetrievePrivateNetworkListExecute(r ApiRetrievePrivateNetworkListRequest) (ListPrivateNetworkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.RetrievePrivateNetworkList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
/*
UnassignInstancePrivateNetwork Remove instance from a Private Network
...
*/
func (a *PrivateNetworksApiService) UnassignInstancePrivateNetwork(ctx _context.Context, privateNetworkId int64, instanceId int64) ApiUnassignInstancePrivateNetworkRequest {
	return ApiUnassignInstancePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
		privateNetworkId: privateNetworkId,
...
func (a *PrivateNetworksApiService) UnassignInstancePrivateNetworkExecute(r ApiUnassignInstancePrivateNetworkRequest) (UnassignInstancePrivateNetworkResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivateNetworksApiService.UnassignInstancePrivateNetwork")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
