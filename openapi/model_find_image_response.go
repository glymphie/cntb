...
// FindImageResponse struct for FindImageResponse
...
func (o FindImageResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindImageResponse struct {
	value *FindImageResponse
	isSet bool
}

func (v NullableFindImageResponse) Get() *FindImageResponse {
	return v.value
}

func (v *NullableFindImageResponse) Set(val *FindImageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindImageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindImageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindImageResponse(val *FindImageResponse) *NullableFindImageResponse {
	return &NullableFindImageResponse{value: val, isSet: true}
}

func (v NullableFindImageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindImageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
