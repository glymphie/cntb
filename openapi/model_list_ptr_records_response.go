...
// ListPtrRecordsResponse struct for ListPtrRecordsResponse
type ListPtrRecordsResponse struct {
	...
	Data []PtrRecordResponse `json:"data"`
...
func (o ListPtrRecordsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListPtrRecordsResponse struct {
	value *ListPtrRecordsResponse
	isSet bool
}

func (v NullableListPtrRecordsResponse) Get() *ListPtrRecordsResponse {
	return v.value
}

func (v *NullableListPtrRecordsResponse) Set(val *ListPtrRecordsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListPtrRecordsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListPtrRecordsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPtrRecordsResponse(val *ListPtrRecordsResponse) *NullableListPtrRecordsResponse {
	return &NullableListPtrRecordsResponse{value: val, isSet: true}
}

func (v NullableListPtrRecordsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPtrRecordsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
