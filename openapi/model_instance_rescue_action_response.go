...
// InstanceRescueActionResponse struct for InstanceRescueActionResponse
...
func NewInstanceRescueActionResponse(data []InstanceRescueActionResponseData, links SelfLinks) *InstanceRescueActionResponse {
	this := InstanceRescueActionResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceRescueActionResponse) GetData() []InstanceRescueActionResponseData {
	if o == nil {
		var ret []InstanceRescueActionResponseData
		return ret
	}
...
func (o InstanceRescueActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceRescueActionResponse struct {
	value *InstanceRescueActionResponse
	isSet bool
}

func (v NullableInstanceRescueActionResponse) Get() *InstanceRescueActionResponse {
	return v.value
}

func (v *NullableInstanceRescueActionResponse) Set(val *InstanceRescueActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceRescueActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceRescueActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceRescueActionResponse(val *InstanceRescueActionResponse) *NullableInstanceRescueActionResponse {
	return &NullableInstanceRescueActionResponse{value: val, isSet: true}
}

func (v NullableInstanceRescueActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceRescueActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
