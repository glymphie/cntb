...
// ListPrivateNetworkAuditResponse struct for ListPrivateNetworkAuditResponse
...
func NewListPrivateNetworkAuditResponse(pagination PaginationMeta, data []PrivateNetworkAuditResponse, links Links) *ListPrivateNetworkAuditResponse {
	this := ListPrivateNetworkAuditResponse{}
...
func (o *ListPrivateNetworkAuditResponse) GetData() []PrivateNetworkAuditResponse {
	if o == nil {
		var ret []PrivateNetworkAuditResponse
		return ret
	}
...
func (o ListPrivateNetworkAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListPrivateNetworkAuditResponse struct {
	value *ListPrivateNetworkAuditResponse
	isSet bool
}

func (v NullableListPrivateNetworkAuditResponse) Get() *ListPrivateNetworkAuditResponse {
	return v.value
}

func (v *NullableListPrivateNetworkAuditResponse) Set(val *ListPrivateNetworkAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListPrivateNetworkAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListPrivateNetworkAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPrivateNetworkAuditResponse(val *ListPrivateNetworkAuditResponse) *NullableListPrivateNetworkAuditResponse {
	return &NullableListPrivateNetworkAuditResponse{value: val, isSet: true}
}

func (v NullableListPrivateNetworkAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPrivateNetworkAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
