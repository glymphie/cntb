...
// ListVipResponse struct for ListVipResponse
...
func (o ListVipResponse) MarshalJSON() ([]byte, error) {
...
type NullableListVipResponse struct {
	value *ListVipResponse
	isSet bool
}

func (v NullableListVipResponse) Get() *ListVipResponse {
	return v.value
}

func (v *NullableListVipResponse) Set(val *ListVipResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListVipResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListVipResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVipResponse(val *ListVipResponse) *NullableListVipResponse {
	return &NullableListVipResponse{value: val, isSet: true}
}

func (v NullableListVipResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVipResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
