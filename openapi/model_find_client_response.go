...
// FindClientResponse struct for FindClientResponse
...
func (o FindClientResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindClientResponse struct {
	value *FindClientResponse
	isSet bool
}

func (v NullableFindClientResponse) Get() *FindClientResponse {
	return v.value
}

func (v *NullableFindClientResponse) Set(val *FindClientResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindClientResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindClientResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindClientResponse(val *FindClientResponse) *NullableFindClientResponse {
	return &NullableFindClientResponse{value: val, isSet: true}
}

func (v NullableFindClientResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindClientResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
